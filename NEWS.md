...
- Introduced changes to progress bars, most notably moved them to the GitHost level to display high-level progress ([#687](https://github.com/r-world-devs/GitStats/issues/687), [#695](https://github.com/r-world-devs/GitStats/issues/695)).
