...
- Replaced per-directory GraphQL file tree traversal with single-call REST recursive tree API for `get_repos_trees()` ([#740](https://github.com/r-world-devs/GitStats/issues/740)).
