                            ...
                            private = list(
                              ...
                              find_projects_by_id = function(projects_ids,
                                ...
                                projects_list <- purrr::map(projects_ids, function(x){
                                  ...
                                  content <- perform_get_request(paste0(api_url, "/projects/", x,""),
                                                                  token)
                              ...
                              get_all_commits_from_group = function(project_group,
                                ...
                                commits_list <- perform_get_request(endpoint = paste0(self$rest_api_url, "/groups/", project_group, "/projects"),
                                                    token = private$token) %>%
                                  purrr::map_chr(~.$id) %>%
                                  purrr::map(~perform_get_request(endpoint = paste0(self$rest_api_url,
                                                                                    "/projects/",
                                                                                    . ,
                                ...
                                commits_list <- purrr::map(commits_list, function(x){
                                  ...
                                  purrr::map(x, function(y){
                                    ...
                                    list(
                                      ...
                                      "repo_project" = gsub(pattern = paste0("/-/commit/", y$id),
                                                            replacement = "",
