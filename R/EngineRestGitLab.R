EngineRestGitLab <- R6::R6Class("EngineRestGitLab",
  ...
  public = list(
    ...
    get_commits_from_org = function(repos_table,
                                    org,
                                    date_from,
                                    date_until,
                                    by,
                                    team) {
      self$pull_commits_from_org(
        repos_table,
        org,
        date_from,
        date_until
        ...
        self$tailor_commits_info(org = org)  %>%
        self$prepare_commits_table()
    },
