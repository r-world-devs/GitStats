...
# `pull_repos_page_from_org()` pulls repos page from organization
    ...
    Output
      ...
      [1] "2023-04-14T10:36:24Z"
      
      $data$repositoryOwner$repositories$nodes[[8]]$last_activity_at
      [1] "2023-04-14T10:36:28Z"
      
      $data$repositoryOwner$repositories$nodes[[8]]$languages
      $data$repositoryOwner$repositories$nodes[[8]]$languages$nodes
      $data$repositoryOwner$repositories$nodes[[8]]$languages$nodes[[1]]
      $data$repositoryOwner$repositories$nodes[[8]]$languages$nodes[[1]]$name
      [1] "R"
      
      
      $data$repositoryOwner$repositories$nodes[[8]]$languages$nodes[[2]]
      $data$repositoryOwner$repositories$nodes[[8]]$languages$nodes[[2]]$name
      [1] "JavaScript"
      ...
      $data$repositoryOwner$repositories$nodes[[8]]$contributors$target
      $data$repositoryOwner$repositories$nodes[[8]]$contributors$target$id
      [1] "C_kwDOJWYrCNoAKDAzM2IwNmFhM2RjY2ZkNzVmNTY4NjFiNTEzNzQyZjlhNThjMjRmOTc"
      
      $data$repositoryOwner$repositories$nodes[[8]]$contributors$target$history
      $data$repositoryOwner$repositories$nodes[[8]]$contributors$target$history$edges
      $data$repositoryOwner$repositories$nodes[[8]]$contributors$target$history$edges[[1]]
      $data$repositoryOwner$repositories$nodes[[8]]$contributors$target$history$edges[[1]]$node
      $data$repositoryOwner$repositories$nodes[[8]]$contributors$target$history$edges[[1]]$node$committer
      $data$repositoryOwner$repositories$nodes[[8]]$contributors$target$history$edges[[1]]$node$committer$user
      $data$repositoryOwner$repositories$nodes[[8]]$contributors$target$history$edges[[1]]$node$committer$user$login
      [1] "krystian8207"
      
      $data$repositoryOwner$repositories$nodes[[8]]$contributors$target$history$edges[[1]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
