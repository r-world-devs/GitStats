...
# `pull_repos_page_from_org()` pulls repos page from organization
...
# `pull_commits_page_from_repo()` pulls commits page from repository
...
# `pull_repos_from_org()` prepares formatted list
    ...
    Output
      ...
      [[1]]$languages$nodes
      [[1]]$languages$nodes[[1]]
      [[1]]$languages$nodes[[1]]$name
      [1] "R"
      
      
      [[1]]$languages$nodes[[2]]
      [[1]]$languages$nodes[[2]]$name
      [1] "CSS"
      
      
      [[1]]$languages$nodes[[3]]
      [[1]]$languages$nodes[[3]]$name
      [1] "JavaScript"
      ...
      [[1]]$issues_open
      [[1]]$issues_open$totalCount
      [1] 5
      
      
      [[1]]$issues_closed
      [[1]]$issues_closed$totalCount
      [1] 12
      
      
      [[1]]$contributors
      [[1]]$contributors$target
      [[1]]$contributors$target$id
      [1] "C_kwDOHNMr29oAKDQ5MGQ3Yzc0MjVjYTYwMDc5YTJkMTA0MTQ2NWRlZGU2ZTI2YzA1YmI"
      
      [[1]]$contributors$target$history
      [[1]]$contributors$target$history$edges
      [[1]]$contributors$target$history$edges[[1]]
      [[1]]$contributors$target$history$edges[[1]]$node
      [[1]]$contributors$target$history$edges[[1]]$node$committer
      [[1]]$contributors$target$history$edges[[1]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[2]]
      [[1]]$contributors$target$history$edges[[2]]$node
      [[1]]$contributors$target$history$edges[[2]]$node$committer
      [[1]]$contributors$target$history$edges[[2]]$node$committer$user
      [[1]]$contributors$target$history$edges[[2]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[2]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[3]]
      [[1]]$contributors$target$history$edges[[3]]$node
      [[1]]$contributors$target$history$edges[[3]]$node$committer
      [[1]]$contributors$target$history$edges[[3]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[4]]
      [[1]]$contributors$target$history$edges[[4]]$node
      [[1]]$contributors$target$history$edges[[4]]$node$committer
      [[1]]$contributors$target$history$edges[[4]]$node$committer$user
      [[1]]$contributors$target$history$edges[[4]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[4]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[5]]
      [[1]]$contributors$target$history$edges[[5]]$node
      [[1]]$contributors$target$history$edges[[5]]$node$committer
      [[1]]$contributors$target$history$edges[[5]]$node$committer$user
      [[1]]$contributors$target$history$edges[[5]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[5]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[6]]
      [[1]]$contributors$target$history$edges[[6]]$node
      [[1]]$contributors$target$history$edges[[6]]$node$committer
      [[1]]$contributors$target$history$edges[[6]]$node$committer$user
      [[1]]$contributors$target$history$edges[[6]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[6]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[7]]
      [[1]]$contributors$target$history$edges[[7]]$node
      [[1]]$contributors$target$history$edges[[7]]$node$committer
      [[1]]$contributors$target$history$edges[[7]]$node$committer$user
      [[1]]$contributors$target$history$edges[[7]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[7]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[8]]
      [[1]]$contributors$target$history$edges[[8]]$node
      [[1]]$contributors$target$history$edges[[8]]$node$committer
      [[1]]$contributors$target$history$edges[[8]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[9]]
      [[1]]$contributors$target$history$edges[[9]]$node
      [[1]]$contributors$target$history$edges[[9]]$node$committer
      [[1]]$contributors$target$history$edges[[9]]$node$committer$user
      [[1]]$contributors$target$history$edges[[9]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[9]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[10]]
      [[1]]$contributors$target$history$edges[[10]]$node
      [[1]]$contributors$target$history$edges[[10]]$node$committer
      [[1]]$contributors$target$history$edges[[10]]$node$committer$user
      [[1]]$contributors$target$history$edges[[10]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[10]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[11]]
      [[1]]$contributors$target$history$edges[[11]]$node
      [[1]]$contributors$target$history$edges[[11]]$node$committer
      [[1]]$contributors$target$history$edges[[11]]$node$committer$user
      [[1]]$contributors$target$history$edges[[11]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[11]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[12]]
      [[1]]$contributors$target$history$edges[[12]]$node
      [[1]]$contributors$target$history$edges[[12]]$node$committer
      [[1]]$contributors$target$history$edges[[12]]$node$committer$user
      [[1]]$contributors$target$history$edges[[12]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[12]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[13]]
      [[1]]$contributors$target$history$edges[[13]]$node
      [[1]]$contributors$target$history$edges[[13]]$node$committer
      [[1]]$contributors$target$history$edges[[13]]$node$committer$user
      [[1]]$contributors$target$history$edges[[13]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[13]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[14]]
      [[1]]$contributors$target$history$edges[[14]]$node
      [[1]]$contributors$target$history$edges[[14]]$node$committer
      [[1]]$contributors$target$history$edges[[14]]$node$committer$user
      [[1]]$contributors$target$history$edges[[14]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[14]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[15]]
      [[1]]$contributors$target$history$edges[[15]]$node
      [[1]]$contributors$target$history$edges[[15]]$node$committer
      [[1]]$contributors$target$history$edges[[15]]$node$committer$user
      [[1]]$contributors$target$history$edges[[15]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[15]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[16]]
      [[1]]$contributors$target$history$edges[[16]]$node
      [[1]]$contributors$target$history$edges[[16]]$node$committer
      [[1]]$contributors$target$history$edges[[16]]$node$committer$user
      [[1]]$contributors$target$history$edges[[16]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[16]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[17]]
      [[1]]$contributors$target$history$edges[[17]]$node
      [[1]]$contributors$target$history$edges[[17]]$node$committer
      [[1]]$contributors$target$history$edges[[17]]$node$committer$user
      [[1]]$contributors$target$history$edges[[17]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[17]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[18]]
      [[1]]$contributors$target$history$edges[[18]]$node
      [[1]]$contributors$target$history$edges[[18]]$node$committer
      [[1]]$contributors$target$history$edges[[18]]$node$committer$user
      [[1]]$contributors$target$history$edges[[18]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[18]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[19]]
      [[1]]$contributors$target$history$edges[[19]]$node
      [[1]]$contributors$target$history$edges[[19]]$node$committer
      [[1]]$contributors$target$history$edges[[19]]$node$committer$user
      [[1]]$contributors$target$history$edges[[19]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[19]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[20]]
      [[1]]$contributors$target$history$edges[[20]]$node
      [[1]]$contributors$target$history$edges[[20]]$node$committer
      [[1]]$contributors$target$history$edges[[20]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[21]]
      [[1]]$contributors$target$history$edges[[21]]$node
      [[1]]$contributors$target$history$edges[[21]]$node$committer
      [[1]]$contributors$target$history$edges[[21]]$node$committer$user
      [[1]]$contributors$target$history$edges[[21]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[21]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[22]]
      [[1]]$contributors$target$history$edges[[22]]$node
      [[1]]$contributors$target$history$edges[[22]]$node$committer
      [[1]]$contributors$target$history$edges[[22]]$node$committer$user
      [[1]]$contributors$target$history$edges[[22]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[22]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[23]]
      [[1]]$contributors$target$history$edges[[23]]$node
      [[1]]$contributors$target$history$edges[[23]]$node$committer
      [[1]]$contributors$target$history$edges[[23]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[24]]
      [[1]]$contributors$target$history$edges[[24]]$node
      [[1]]$contributors$target$history$edges[[24]]$node$committer
      [[1]]$contributors$target$history$edges[[24]]$node$committer$user
      [[1]]$contributors$target$history$edges[[24]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[24]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[25]]
      [[1]]$contributors$target$history$edges[[25]]$node
      [[1]]$contributors$target$history$edges[[25]]$node$committer
      [[1]]$contributors$target$history$edges[[25]]$node$committer$user
      [[1]]$contributors$target$history$edges[[25]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[25]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[26]]
      [[1]]$contributors$target$history$edges[[26]]$node
      [[1]]$contributors$target$history$edges[[26]]$node$committer
      [[1]]$contributors$target$history$edges[[26]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[27]]
      [[1]]$contributors$target$history$edges[[27]]$node
      [[1]]$contributors$target$history$edges[[27]]$node$committer
      [[1]]$contributors$target$history$edges[[27]]$node$committer$user
      [[1]]$contributors$target$history$edges[[27]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[27]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[28]]
      [[1]]$contributors$target$history$edges[[28]]$node
      [[1]]$contributors$target$history$edges[[28]]$node$committer
      [[1]]$contributors$target$history$edges[[28]]$node$committer$user
      [[1]]$contributors$target$history$edges[[28]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[28]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[29]]
      [[1]]$contributors$target$history$edges[[29]]$node
      [[1]]$contributors$target$history$edges[[29]]$node$committer
      [[1]]$contributors$target$history$edges[[29]]$node$committer$user
      [[1]]$contributors$target$history$edges[[29]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[29]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[30]]
      [[1]]$contributors$target$history$edges[[30]]$node
      [[1]]$contributors$target$history$edges[[30]]$node$committer
      [[1]]$contributors$target$history$edges[[30]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[31]]
      [[1]]$contributors$target$history$edges[[31]]$node
      [[1]]$contributors$target$history$edges[[31]]$node$committer
      [[1]]$contributors$target$history$edges[[31]]$node$committer$user
      [[1]]$contributors$target$history$edges[[31]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[31]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[32]]
      [[1]]$contributors$target$history$edges[[32]]$node
      [[1]]$contributors$target$history$edges[[32]]$node$committer
      [[1]]$contributors$target$history$edges[[32]]$node$committer$user
      [[1]]$contributors$target$history$edges[[32]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[32]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[33]]
      [[1]]$contributors$target$history$edges[[33]]$node
      [[1]]$contributors$target$history$edges[[33]]$node$committer
      [[1]]$contributors$target$history$edges[[33]]$node$committer$user
      [[1]]$contributors$target$history$edges[[33]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[33]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[34]]
      [[1]]$contributors$target$history$edges[[34]]$node
      [[1]]$contributors$target$history$edges[[34]]$node$committer
      [[1]]$contributors$target$history$edges[[34]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[35]]
      [[1]]$contributors$target$history$edges[[35]]$node
      [[1]]$contributors$target$history$edges[[35]]$node$committer
      [[1]]$contributors$target$history$edges[[35]]$node$committer$user
      [[1]]$contributors$target$history$edges[[35]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[35]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[36]]
      [[1]]$contributors$target$history$edges[[36]]$node
      [[1]]$contributors$target$history$edges[[36]]$node$committer
      [[1]]$contributors$target$history$edges[[36]]$node$committer$user
      [[1]]$contributors$target$history$edges[[36]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[36]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[37]]
      [[1]]$contributors$target$history$edges[[37]]$node
      [[1]]$contributors$target$history$edges[[37]]$node$committer
      [[1]]$contributors$target$history$edges[[37]]$node$committer$user
      [[1]]$contributors$target$history$edges[[37]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[37]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[38]]
      [[1]]$contributors$target$history$edges[[38]]$node
      [[1]]$contributors$target$history$edges[[38]]$node$committer
      [[1]]$contributors$target$history$edges[[38]]$node$committer$user
      [[1]]$contributors$target$history$edges[[38]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[38]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[39]]
      [[1]]$contributors$target$history$edges[[39]]$node
      [[1]]$contributors$target$history$edges[[39]]$node$committer
      [[1]]$contributors$target$history$edges[[39]]$node$committer$user
      [[1]]$contributors$target$history$edges[[39]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[39]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[40]]
      [[1]]$contributors$target$history$edges[[40]]$node
      [[1]]$contributors$target$history$edges[[40]]$node$committer
      [[1]]$contributors$target$history$edges[[40]]$node$committer$user
      [[1]]$contributors$target$history$edges[[40]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[40]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[41]]
      [[1]]$contributors$target$history$edges[[41]]$node
      [[1]]$contributors$target$history$edges[[41]]$node$committer
      [[1]]$contributors$target$history$edges[[41]]$node$committer$user
      [[1]]$contributors$target$history$edges[[41]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[41]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[42]]
      [[1]]$contributors$target$history$edges[[42]]$node
      [[1]]$contributors$target$history$edges[[42]]$node$committer
      [[1]]$contributors$target$history$edges[[42]]$node$committer$user
      [[1]]$contributors$target$history$edges[[42]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[42]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[43]]
      [[1]]$contributors$target$history$edges[[43]]$node
      [[1]]$contributors$target$history$edges[[43]]$node$committer
      [[1]]$contributors$target$history$edges[[43]]$node$committer$user
      [[1]]$contributors$target$history$edges[[43]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[43]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[44]]
      [[1]]$contributors$target$history$edges[[44]]$node
      [[1]]$contributors$target$history$edges[[44]]$node$committer
      [[1]]$contributors$target$history$edges[[44]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[45]]
      [[1]]$contributors$target$history$edges[[45]]$node
      [[1]]$contributors$target$history$edges[[45]]$node$committer
      [[1]]$contributors$target$history$edges[[45]]$node$committer$user
      [[1]]$contributors$target$history$edges[[45]]$node$committer$user$login
      [1] "stla"
      
      [[1]]$contributors$target$history$edges[[45]]$node$committer$user$id
      [1] "MDQ6VXNlcjQ0NjY1NDM="
      ...
      [[1]]$contributors$target$history$edges[[46]]
      [[1]]$contributors$target$history$edges[[46]]$node
      [[1]]$contributors$target$history$edges[[46]]$node$committer
      [[1]]$contributors$target$history$edges[[46]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[47]]
      [[1]]$contributors$target$history$edges[[47]]$node
      [[1]]$contributors$target$history$edges[[47]]$node$committer
      [[1]]$contributors$target$history$edges[[47]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[48]]
      [[1]]$contributors$target$history$edges[[48]]$node
      [[1]]$contributors$target$history$edges[[48]]$node$committer
      [[1]]$contributors$target$history$edges[[48]]$node$committer$user
      [[1]]$contributors$target$history$edges[[48]]$node$committer$user$login
      [1] "stlagsk"
      
      [[1]]$contributors$target$history$edges[[48]]$node$committer$user$id
      [1] "MDQ6VXNlcjg4NzY3MDM1"
      ...
      [[1]]$contributors$target$history$edges[[49]]
      [[1]]$contributors$target$history$edges[[49]]$node
      [[1]]$contributors$target$history$edges[[49]]$node$committer
      [[1]]$contributors$target$history$edges[[49]]$node$committer$user
      [[1]]$contributors$target$history$edges[[49]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[49]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[50]]
      [[1]]$contributors$target$history$edges[[50]]$node
      [[1]]$contributors$target$history$edges[[50]]$node$committer
      [[1]]$contributors$target$history$edges[[50]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[51]]
      [[1]]$contributors$target$history$edges[[51]]$node
      [[1]]$contributors$target$history$edges[[51]]$node$committer
      [[1]]$contributors$target$history$edges[[51]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[52]]
      [[1]]$contributors$target$history$edges[[52]]$node
      [[1]]$contributors$target$history$edges[[52]]$node$committer
      [[1]]$contributors$target$history$edges[[52]]$node$committer$user
      [[1]]$contributors$target$history$edges[[52]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[52]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[53]]
      [[1]]$contributors$target$history$edges[[53]]$node
      [[1]]$contributors$target$history$edges[[53]]$node$committer
      [[1]]$contributors$target$history$edges[[53]]$node$committer$user
      [[1]]$contributors$target$history$edges[[53]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[53]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[54]]
      [[1]]$contributors$target$history$edges[[54]]$node
      [[1]]$contributors$target$history$edges[[54]]$node$committer
      [[1]]$contributors$target$history$edges[[54]]$node$committer$user
      [[1]]$contributors$target$history$edges[[54]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[54]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[55]]
      [[1]]$contributors$target$history$edges[[55]]$node
      [[1]]$contributors$target$history$edges[[55]]$node$committer
      [[1]]$contributors$target$history$edges[[55]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[56]]
      [[1]]$contributors$target$history$edges[[56]]$node
      [[1]]$contributors$target$history$edges[[56]]$node$committer
      [[1]]$contributors$target$history$edges[[56]]$node$committer$user
      [[1]]$contributors$target$history$edges[[56]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[56]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[57]]
      [[1]]$contributors$target$history$edges[[57]]$node
      [[1]]$contributors$target$history$edges[[57]]$node$committer
      [[1]]$contributors$target$history$edges[[57]]$node$committer$user
      [[1]]$contributors$target$history$edges[[57]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[57]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[58]]
      [[1]]$contributors$target$history$edges[[58]]$node
      [[1]]$contributors$target$history$edges[[58]]$node$committer
      [[1]]$contributors$target$history$edges[[58]]$node$committer$user
      [[1]]$contributors$target$history$edges[[58]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[58]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[59]]
      [[1]]$contributors$target$history$edges[[59]]$node
      [[1]]$contributors$target$history$edges[[59]]$node$committer
      [[1]]$contributors$target$history$edges[[59]]$node$committer$user
      [[1]]$contributors$target$history$edges[[59]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[59]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[60]]
      [[1]]$contributors$target$history$edges[[60]]$node
      [[1]]$contributors$target$history$edges[[60]]$node$committer
      [[1]]$contributors$target$history$edges[[60]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[61]]
      [[1]]$contributors$target$history$edges[[61]]$node
      [[1]]$contributors$target$history$edges[[61]]$node$committer
      [[1]]$contributors$target$history$edges[[61]]$node$committer$user
      [[1]]$contributors$target$history$edges[[61]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[61]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[62]]
      [[1]]$contributors$target$history$edges[[62]]$node
      [[1]]$contributors$target$history$edges[[62]]$node$committer
      [[1]]$contributors$target$history$edges[[62]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[63]]
      [[1]]$contributors$target$history$edges[[63]]$node
      [[1]]$contributors$target$history$edges[[63]]$node$committer
      [[1]]$contributors$target$history$edges[[63]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[64]]
      [[1]]$contributors$target$history$edges[[64]]$node
      [[1]]$contributors$target$history$edges[[64]]$node$committer
      [[1]]$contributors$target$history$edges[[64]]$node$committer$user
      [[1]]$contributors$target$history$edges[[64]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[64]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[65]]
      [[1]]$contributors$target$history$edges[[65]]$node
      [[1]]$contributors$target$history$edges[[65]]$node$committer
      [[1]]$contributors$target$history$edges[[65]]$node$committer$user
      [[1]]$contributors$target$history$edges[[65]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[65]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[66]]
      [[1]]$contributors$target$history$edges[[66]]$node
      [[1]]$contributors$target$history$edges[[66]]$node$committer
      [[1]]$contributors$target$history$edges[[66]]$node$committer$user
      [[1]]$contributors$target$history$edges[[66]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[66]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[67]]
      [[1]]$contributors$target$history$edges[[67]]$node
      [[1]]$contributors$target$history$edges[[67]]$node$committer
      [[1]]$contributors$target$history$edges[[67]]$node$committer$user
      [[1]]$contributors$target$history$edges[[67]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[67]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[68]]
      [[1]]$contributors$target$history$edges[[68]]$node
      [[1]]$contributors$target$history$edges[[68]]$node$committer
      [[1]]$contributors$target$history$edges[[68]]$node$committer$user
      [[1]]$contributors$target$history$edges[[68]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[68]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[69]]
      [[1]]$contributors$target$history$edges[[69]]$node
      [[1]]$contributors$target$history$edges[[69]]$node$committer
      [[1]]$contributors$target$history$edges[[69]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[70]]
      [[1]]$contributors$target$history$edges[[70]]$node
      [[1]]$contributors$target$history$edges[[70]]$node$committer
      [[1]]$contributors$target$history$edges[[70]]$node$committer$user
      [[1]]$contributors$target$history$edges[[70]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[70]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[71]]
      [[1]]$contributors$target$history$edges[[71]]$node
      [[1]]$contributors$target$history$edges[[71]]$node$committer
      [[1]]$contributors$target$history$edges[[71]]$node$committer$user
      [[1]]$contributors$target$history$edges[[71]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[71]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[72]]
      [[1]]$contributors$target$history$edges[[72]]$node
      [[1]]$contributors$target$history$edges[[72]]$node$committer
      [[1]]$contributors$target$history$edges[[72]]$node$committer$user
      [[1]]$contributors$target$history$edges[[72]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[72]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[73]]
      [[1]]$contributors$target$history$edges[[73]]$node
      [[1]]$contributors$target$history$edges[[73]]$node$committer
      [[1]]$contributors$target$history$edges[[73]]$node$committer$user
      [[1]]$contributors$target$history$edges[[73]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[73]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[74]]
      [[1]]$contributors$target$history$edges[[74]]$node
      [[1]]$contributors$target$history$edges[[74]]$node$committer
      [[1]]$contributors$target$history$edges[[74]]$node$committer$user
      [[1]]$contributors$target$history$edges[[74]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[74]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[75]]
      [[1]]$contributors$target$history$edges[[75]]$node
      [[1]]$contributors$target$history$edges[[75]]$node$committer
      [[1]]$contributors$target$history$edges[[75]]$node$committer$user
      [[1]]$contributors$target$history$edges[[75]]$node$committer$user$login
      [1] "stla"
      
      [[1]]$contributors$target$history$edges[[75]]$node$committer$user$id
      [1] "MDQ6VXNlcjQ0NjY1NDM="
      ...
      [[1]]$contributors$target$history$edges[[76]]
      [[1]]$contributors$target$history$edges[[76]]$node
      [[1]]$contributors$target$history$edges[[76]]$node$committer
      [[1]]$contributors$target$history$edges[[76]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[77]]
      [[1]]$contributors$target$history$edges[[77]]$node
      [[1]]$contributors$target$history$edges[[77]]$node$committer
      [[1]]$contributors$target$history$edges[[77]]$node$committer$user
      [[1]]$contributors$target$history$edges[[77]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[77]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[78]]
      [[1]]$contributors$target$history$edges[[78]]$node
      [[1]]$contributors$target$history$edges[[78]]$node$committer
      [[1]]$contributors$target$history$edges[[78]]$node$committer$user
      [[1]]$contributors$target$history$edges[[78]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[78]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[79]]
      [[1]]$contributors$target$history$edges[[79]]$node
      [[1]]$contributors$target$history$edges[[79]]$node$committer
      [[1]]$contributors$target$history$edges[[79]]$node$committer$user
      [[1]]$contributors$target$history$edges[[79]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[79]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[80]]
      [[1]]$contributors$target$history$edges[[80]]$node
      [[1]]$contributors$target$history$edges[[80]]$node$committer
      [[1]]$contributors$target$history$edges[[80]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[81]]
      [[1]]$contributors$target$history$edges[[81]]$node
      [[1]]$contributors$target$history$edges[[81]]$node$committer
      [[1]]$contributors$target$history$edges[[81]]$node$committer$user
      [[1]]$contributors$target$history$edges[[81]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[81]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[82]]
      [[1]]$contributors$target$history$edges[[82]]$node
      [[1]]$contributors$target$history$edges[[82]]$node$committer
      [[1]]$contributors$target$history$edges[[82]]$node$committer$user
      [[1]]$contributors$target$history$edges[[82]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[82]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[83]]
      [[1]]$contributors$target$history$edges[[83]]$node
      [[1]]$contributors$target$history$edges[[83]]$node$committer
      [[1]]$contributors$target$history$edges[[83]]$node$committer$user
      [[1]]$contributors$target$history$edges[[83]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[83]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[84]]
      [[1]]$contributors$target$history$edges[[84]]$node
      [[1]]$contributors$target$history$edges[[84]]$node$committer
      [[1]]$contributors$target$history$edges[[84]]$node$committer$user
      [[1]]$contributors$target$history$edges[[84]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[84]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[85]]
      [[1]]$contributors$target$history$edges[[85]]$node
      [[1]]$contributors$target$history$edges[[85]]$node$committer
      [[1]]$contributors$target$history$edges[[85]]$node$committer$user
      [[1]]$contributors$target$history$edges[[85]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[85]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[86]]
      [[1]]$contributors$target$history$edges[[86]]$node
      [[1]]$contributors$target$history$edges[[86]]$node$committer
      [[1]]$contributors$target$history$edges[[86]]$node$committer$user
      [[1]]$contributors$target$history$edges[[86]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[86]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[87]]
      [[1]]$contributors$target$history$edges[[87]]$node
      [[1]]$contributors$target$history$edges[[87]]$node$committer
      [[1]]$contributors$target$history$edges[[87]]$node$committer$user
      [[1]]$contributors$target$history$edges[[87]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[87]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[88]]
      [[1]]$contributors$target$history$edges[[88]]$node
      [[1]]$contributors$target$history$edges[[88]]$node$committer
      [[1]]$contributors$target$history$edges[[88]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[89]]
      [[1]]$contributors$target$history$edges[[89]]$node
      [[1]]$contributors$target$history$edges[[89]]$node$committer
      [[1]]$contributors$target$history$edges[[89]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[90]]
      [[1]]$contributors$target$history$edges[[90]]$node
      [[1]]$contributors$target$history$edges[[90]]$node$committer
      [[1]]$contributors$target$history$edges[[90]]$node$committer$user
      [[1]]$contributors$target$history$edges[[90]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[90]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[91]]
      [[1]]$contributors$target$history$edges[[91]]$node
      [[1]]$contributors$target$history$edges[[91]]$node$committer
      [[1]]$contributors$target$history$edges[[91]]$node$committer$user
      [[1]]$contributors$target$history$edges[[91]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[91]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[92]]
      [[1]]$contributors$target$history$edges[[92]]$node
      [[1]]$contributors$target$history$edges[[92]]$node$committer
      [[1]]$contributors$target$history$edges[[92]]$node$committer$user
      [[1]]$contributors$target$history$edges[[92]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[92]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[93]]
      [[1]]$contributors$target$history$edges[[93]]$node
      [[1]]$contributors$target$history$edges[[93]]$node$committer
      [[1]]$contributors$target$history$edges[[93]]$node$committer$user
      [[1]]$contributors$target$history$edges[[93]]$node$committer$user$login
      [1] "galachad"
      
      [[1]]$contributors$target$history$edges[[93]]$node$committer$user$id
      [1] "MDQ6VXNlcjQyOTYzOTA="
      ...
      [[1]]$contributors$target$history$edges[[94]]
      [[1]]$contributors$target$history$edges[[94]]$node
      [[1]]$contributors$target$history$edges[[94]]$node$committer
      [[1]]$contributors$target$history$edges[[94]]$node$committer$user
      [[1]]$contributors$target$history$edges[[94]]$node$committer$user$login
      [1] "galachad"
      
      [[1]]$contributors$target$history$edges[[94]]$node$committer$user$id
      [1] "MDQ6VXNlcjQyOTYzOTA="
      ...
      [[1]]$contributors$target$history$edges[[95]]
      [[1]]$contributors$target$history$edges[[95]]$node
      [[1]]$contributors$target$history$edges[[95]]$node$committer
      [[1]]$contributors$target$history$edges[[95]]$node$committer$user
      [[1]]$contributors$target$history$edges[[95]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[95]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[96]]
      [[1]]$contributors$target$history$edges[[96]]$node
      [[1]]$contributors$target$history$edges[[96]]$node$committer
      [[1]]$contributors$target$history$edges[[96]]$node$committer$user
      [[1]]$contributors$target$history$edges[[96]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[96]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[97]]
      [[1]]$contributors$target$history$edges[[97]]$node
      [[1]]$contributors$target$history$edges[[97]]$node$committer
      [[1]]$contributors$target$history$edges[[97]]$node$committer$user
      [[1]]$contributors$target$history$edges[[97]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[97]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[98]]
      [[1]]$contributors$target$history$edges[[98]]$node
      [[1]]$contributors$target$history$edges[[98]]$node$committer
      [[1]]$contributors$target$history$edges[[98]]$node$committer$user
      [[1]]$contributors$target$history$edges[[98]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[98]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[1]]$contributors$target$history$edges[[99]]
      [[1]]$contributors$target$history$edges[[99]]$node
      [[1]]$contributors$target$history$edges[[99]]$node$committer
      [[1]]$contributors$target$history$edges[[99]]$node$committer$user
      NULL
      
      
      
      
      [[1]]$contributors$target$history$edges[[100]]
      [[1]]$contributors$target$history$edges[[100]]$node
      [[1]]$contributors$target$history$edges[[100]]$node$committer
      [[1]]$contributors$target$history$edges[[100]]$node$committer$user
      [[1]]$contributors$target$history$edges[[100]]$node$committer$user$login
      [1] "krystian8207"
      
      [[1]]$contributors$target$history$edges[[100]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$issues_open
      [[2]]$issues_open$totalCount
      [1] 22
      
      
      [[2]]$issues_closed
      [[2]]$issues_closed$totalCount
      [1] 1
      
      
      [[2]]$contributors
      [[2]]$contributors$target
      [[2]]$contributors$target$id
      [1] "C_kwDOHYNOFdoAKDhiMDg5NjE0NmIxMDI5ODgwMDI3NTg4YmUzMTEwNzliMjY2MzMxY2E"
      
      [[2]]$contributors$target$history
      [[2]]$contributors$target$history$edges
      [[2]]$contributors$target$history$edges[[1]]
      [[2]]$contributors$target$history$edges[[1]]$node
      [[2]]$contributors$target$history$edges[[1]]$node$committer
      [[2]]$contributors$target$history$edges[[1]]$node$committer$user
      NULL
      
      
      
      
      [[2]]$contributors$target$history$edges[[2]]
      [[2]]$contributors$target$history$edges[[2]]$node
      [[2]]$contributors$target$history$edges[[2]]$node$committer
      [[2]]$contributors$target$history$edges[[2]]$node$committer$user
      [[2]]$contributors$target$history$edges[[2]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[2]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[3]]
      [[2]]$contributors$target$history$edges[[3]]$node
      [[2]]$contributors$target$history$edges[[3]]$node$committer
      [[2]]$contributors$target$history$edges[[3]]$node$committer$user
      NULL
      
      
      
      
      [[2]]$contributors$target$history$edges[[4]]
      [[2]]$contributors$target$history$edges[[4]]$node
      [[2]]$contributors$target$history$edges[[4]]$node$committer
      [[2]]$contributors$target$history$edges[[4]]$node$committer$user
      [[2]]$contributors$target$history$edges[[4]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[4]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[5]]
      [[2]]$contributors$target$history$edges[[5]]$node
      [[2]]$contributors$target$history$edges[[5]]$node$committer
      [[2]]$contributors$target$history$edges[[5]]$node$committer$user
      [[2]]$contributors$target$history$edges[[5]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[5]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[6]]
      [[2]]$contributors$target$history$edges[[6]]$node
      [[2]]$contributors$target$history$edges[[6]]$node$committer
      [[2]]$contributors$target$history$edges[[6]]$node$committer$user
      [[2]]$contributors$target$history$edges[[6]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[6]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[7]]
      [[2]]$contributors$target$history$edges[[7]]$node
      [[2]]$contributors$target$history$edges[[7]]$node$committer
      [[2]]$contributors$target$history$edges[[7]]$node$committer$user
      [[2]]$contributors$target$history$edges[[7]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[7]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[8]]
      [[2]]$contributors$target$history$edges[[8]]$node
      [[2]]$contributors$target$history$edges[[8]]$node$committer
      [[2]]$contributors$target$history$edges[[8]]$node$committer$user
      [[2]]$contributors$target$history$edges[[8]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[8]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[9]]
      [[2]]$contributors$target$history$edges[[9]]$node
      [[2]]$contributors$target$history$edges[[9]]$node$committer
      [[2]]$contributors$target$history$edges[[9]]$node$committer$user
      [[2]]$contributors$target$history$edges[[9]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[9]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[10]]
      [[2]]$contributors$target$history$edges[[10]]$node
      [[2]]$contributors$target$history$edges[[10]]$node$committer
      [[2]]$contributors$target$history$edges[[10]]$node$committer$user
      NULL
      
      
      
      
      [[2]]$contributors$target$history$edges[[11]]
      [[2]]$contributors$target$history$edges[[11]]$node
      [[2]]$contributors$target$history$edges[[11]]$node$committer
      [[2]]$contributors$target$history$edges[[11]]$node$committer$user
      [[2]]$contributors$target$history$edges[[11]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[11]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[12]]
      [[2]]$contributors$target$history$edges[[12]]$node
      [[2]]$contributors$target$history$edges[[12]]$node$committer
      [[2]]$contributors$target$history$edges[[12]]$node$committer$user
      [[2]]$contributors$target$history$edges[[12]]$node$committer$user$login
      [1] "galachad"
      
      [[2]]$contributors$target$history$edges[[12]]$node$committer$user$id
      [1] "MDQ6VXNlcjQyOTYzOTA="
      ...
      [[2]]$contributors$target$history$edges[[13]]
      [[2]]$contributors$target$history$edges[[13]]$node
      [[2]]$contributors$target$history$edges[[13]]$node$committer
      [[2]]$contributors$target$history$edges[[13]]$node$committer$user
      [[2]]$contributors$target$history$edges[[13]]$node$committer$user$login
      [1] "galachad"
      
      [[2]]$contributors$target$history$edges[[13]]$node$committer$user$id
      [1] "MDQ6VXNlcjQyOTYzOTA="
      ...
      [[2]]$contributors$target$history$edges[[14]]
      [[2]]$contributors$target$history$edges[[14]]$node
      [[2]]$contributors$target$history$edges[[14]]$node$committer
      [[2]]$contributors$target$history$edges[[14]]$node$committer$user
      NULL
      
      
      
      
      [[2]]$contributors$target$history$edges[[15]]
      [[2]]$contributors$target$history$edges[[15]]$node
      [[2]]$contributors$target$history$edges[[15]]$node$committer
      [[2]]$contributors$target$history$edges[[15]]$node$committer$user
      [[2]]$contributors$target$history$edges[[15]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[15]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[16]]
      [[2]]$contributors$target$history$edges[[16]]$node
      [[2]]$contributors$target$history$edges[[16]]$node$committer
      [[2]]$contributors$target$history$edges[[16]]$node$committer$user
      [[2]]$contributors$target$history$edges[[16]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[16]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[17]]
      [[2]]$contributors$target$history$edges[[17]]$node
      [[2]]$contributors$target$history$edges[[17]]$node$committer
      [[2]]$contributors$target$history$edges[[17]]$node$committer$user
      [[2]]$contributors$target$history$edges[[17]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[17]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[18]]
      [[2]]$contributors$target$history$edges[[18]]$node
      [[2]]$contributors$target$history$edges[[18]]$node$committer
      [[2]]$contributors$target$history$edges[[18]]$node$committer$user
      [[2]]$contributors$target$history$edges[[18]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[18]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[19]]
      [[2]]$contributors$target$history$edges[[19]]$node
      [[2]]$contributors$target$history$edges[[19]]$node$committer
      [[2]]$contributors$target$history$edges[[19]]$node$committer$user
      [[2]]$contributors$target$history$edges[[19]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[19]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[20]]
      [[2]]$contributors$target$history$edges[[20]]$node
      [[2]]$contributors$target$history$edges[[20]]$node$committer
      [[2]]$contributors$target$history$edges[[20]]$node$committer$user
      [[2]]$contributors$target$history$edges[[20]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[20]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[21]]
      [[2]]$contributors$target$history$edges[[21]]$node
      [[2]]$contributors$target$history$edges[[21]]$node$committer
      [[2]]$contributors$target$history$edges[[21]]$node$committer$user
      [[2]]$contributors$target$history$edges[[21]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[21]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[22]]
      [[2]]$contributors$target$history$edges[[22]]$node
      [[2]]$contributors$target$history$edges[[22]]$node$committer
      [[2]]$contributors$target$history$edges[[22]]$node$committer$user
      [[2]]$contributors$target$history$edges[[22]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[22]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[23]]
      [[2]]$contributors$target$history$edges[[23]]$node
      [[2]]$contributors$target$history$edges[[23]]$node$committer
      [[2]]$contributors$target$history$edges[[23]]$node$committer$user
      [[2]]$contributors$target$history$edges[[23]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[23]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[24]]
      [[2]]$contributors$target$history$edges[[24]]$node
      [[2]]$contributors$target$history$edges[[24]]$node$committer
      [[2]]$contributors$target$history$edges[[24]]$node$committer$user
      [[2]]$contributors$target$history$edges[[24]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[24]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[25]]
      [[2]]$contributors$target$history$edges[[25]]$node
      [[2]]$contributors$target$history$edges[[25]]$node$committer
      [[2]]$contributors$target$history$edges[[25]]$node$committer$user
      [[2]]$contributors$target$history$edges[[25]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[25]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[26]]
      [[2]]$contributors$target$history$edges[[26]]$node
      [[2]]$contributors$target$history$edges[[26]]$node$committer
      [[2]]$contributors$target$history$edges[[26]]$node$committer$user
      [[2]]$contributors$target$history$edges[[26]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[26]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[27]]
      [[2]]$contributors$target$history$edges[[27]]$node
      [[2]]$contributors$target$history$edges[[27]]$node$committer
      [[2]]$contributors$target$history$edges[[27]]$node$committer$user
      NULL
      
      
      
      
      [[2]]$contributors$target$history$edges[[28]]
      [[2]]$contributors$target$history$edges[[28]]$node
      [[2]]$contributors$target$history$edges[[28]]$node$committer
      [[2]]$contributors$target$history$edges[[28]]$node$committer$user
      [[2]]$contributors$target$history$edges[[28]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[28]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[29]]
      [[2]]$contributors$target$history$edges[[29]]$node
      [[2]]$contributors$target$history$edges[[29]]$node$committer
      [[2]]$contributors$target$history$edges[[29]]$node$committer$user
      NULL
      
      
      
      
      [[2]]$contributors$target$history$edges[[30]]
      [[2]]$contributors$target$history$edges[[30]]$node
      [[2]]$contributors$target$history$edges[[30]]$node$committer
      [[2]]$contributors$target$history$edges[[30]]$node$committer$user
      [[2]]$contributors$target$history$edges[[30]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[30]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[31]]
      [[2]]$contributors$target$history$edges[[31]]$node
      [[2]]$contributors$target$history$edges[[31]]$node$committer
      [[2]]$contributors$target$history$edges[[31]]$node$committer$user
      [[2]]$contributors$target$history$edges[[31]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[31]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[32]]
      [[2]]$contributors$target$history$edges[[32]]$node
      [[2]]$contributors$target$history$edges[[32]]$node$committer
      [[2]]$contributors$target$history$edges[[32]]$node$committer$user
      [[2]]$contributors$target$history$edges[[32]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[32]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[33]]
      [[2]]$contributors$target$history$edges[[33]]$node
      [[2]]$contributors$target$history$edges[[33]]$node$committer
      [[2]]$contributors$target$history$edges[[33]]$node$committer$user
      [[2]]$contributors$target$history$edges[[33]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[33]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[34]]
      [[2]]$contributors$target$history$edges[[34]]$node
      [[2]]$contributors$target$history$edges[[34]]$node$committer
      [[2]]$contributors$target$history$edges[[34]]$node$committer$user
      [[2]]$contributors$target$history$edges[[34]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[34]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[35]]
      [[2]]$contributors$target$history$edges[[35]]$node
      [[2]]$contributors$target$history$edges[[35]]$node$committer
      [[2]]$contributors$target$history$edges[[35]]$node$committer$user
      [[2]]$contributors$target$history$edges[[35]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[35]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[36]]
      [[2]]$contributors$target$history$edges[[36]]$node
      [[2]]$contributors$target$history$edges[[36]]$node$committer
      [[2]]$contributors$target$history$edges[[36]]$node$committer$user
      [[2]]$contributors$target$history$edges[[36]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[36]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[37]]
      [[2]]$contributors$target$history$edges[[37]]$node
      [[2]]$contributors$target$history$edges[[37]]$node$committer
      [[2]]$contributors$target$history$edges[[37]]$node$committer$user
      NULL
      
      
      
      
      [[2]]$contributors$target$history$edges[[38]]
      [[2]]$contributors$target$history$edges[[38]]$node
      [[2]]$contributors$target$history$edges[[38]]$node$committer
      [[2]]$contributors$target$history$edges[[38]]$node$committer$user
      [[2]]$contributors$target$history$edges[[38]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[38]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[39]]
      [[2]]$contributors$target$history$edges[[39]]$node
      [[2]]$contributors$target$history$edges[[39]]$node$committer
      [[2]]$contributors$target$history$edges[[39]]$node$committer$user
      [[2]]$contributors$target$history$edges[[39]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[39]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[40]]
      [[2]]$contributors$target$history$edges[[40]]$node
      [[2]]$contributors$target$history$edges[[40]]$node$committer
      [[2]]$contributors$target$history$edges[[40]]$node$committer$user
      [[2]]$contributors$target$history$edges[[40]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[40]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[41]]
      [[2]]$contributors$target$history$edges[[41]]$node
      [[2]]$contributors$target$history$edges[[41]]$node$committer
      [[2]]$contributors$target$history$edges[[41]]$node$committer$user
      [[2]]$contributors$target$history$edges[[41]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[41]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[42]]
      [[2]]$contributors$target$history$edges[[42]]$node
      [[2]]$contributors$target$history$edges[[42]]$node$committer
      [[2]]$contributors$target$history$edges[[42]]$node$committer$user
      [[2]]$contributors$target$history$edges[[42]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[42]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[43]]
      [[2]]$contributors$target$history$edges[[43]]$node
      [[2]]$contributors$target$history$edges[[43]]$node$committer
      [[2]]$contributors$target$history$edges[[43]]$node$committer$user
      [[2]]$contributors$target$history$edges[[43]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[43]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[44]]
      [[2]]$contributors$target$history$edges[[44]]$node
      [[2]]$contributors$target$history$edges[[44]]$node$committer
      [[2]]$contributors$target$history$edges[[44]]$node$committer$user
      [[2]]$contributors$target$history$edges[[44]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[44]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[45]]
      [[2]]$contributors$target$history$edges[[45]]$node
      [[2]]$contributors$target$history$edges[[45]]$node$committer
      [[2]]$contributors$target$history$edges[[45]]$node$committer$user
      [[2]]$contributors$target$history$edges[[45]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[45]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[46]]
      [[2]]$contributors$target$history$edges[[46]]$node
      [[2]]$contributors$target$history$edges[[46]]$node$committer
      [[2]]$contributors$target$history$edges[[46]]$node$committer$user
      [[2]]$contributors$target$history$edges[[46]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[46]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[47]]
      [[2]]$contributors$target$history$edges[[47]]$node
      [[2]]$contributors$target$history$edges[[47]]$node$committer
      [[2]]$contributors$target$history$edges[[47]]$node$committer$user
      [[2]]$contributors$target$history$edges[[47]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[47]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[2]]$contributors$target$history$edges[[48]]
      [[2]]$contributors$target$history$edges[[48]]$node
      [[2]]$contributors$target$history$edges[[48]]$node$committer
      [[2]]$contributors$target$history$edges[[48]]$node$committer$user
      [[2]]$contributors$target$history$edges[[48]]$node$committer$user$login
      [1] "krystian8207"
      
      [[2]]$contributors$target$history$edges[[48]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$languages$nodes
      [[3]]$languages$nodes[[1]]
      [[3]]$languages$nodes[[1]]$name
      [1] "R"
      
      
      [[3]]$languages$nodes[[2]]
      [[3]]$languages$nodes[[2]]$name
      [1] "CSS"
      
      
      [[3]]$languages$nodes[[3]]
      [[3]]$languages$nodes[[3]]$name
      [1] "JavaScript"
      
      
      [[3]]$languages$nodes[[4]]
      [[3]]$languages$nodes[[4]]$name
      [1] "SCSS"
      ...
      [[3]]$issues_open
      [[3]]$issues_open$totalCount
      [1] 27
      
      
      [[3]]$issues_closed
      [[3]]$issues_closed$totalCount
      [1] 4
      
      
      [[3]]$contributors
      [[3]]$contributors$target
      [[3]]$contributors$target$id
      [1] "C_kwDOHYNrJ9oAKDNkNzFiZjQ0Mjc0ZDRkMzNiMDdlODUzNzVmYTBkZDdmYTdmNDRkNzI"
      
      [[3]]$contributors$target$history
      [[3]]$contributors$target$history$edges
      [[3]]$contributors$target$history$edges[[1]]
      [[3]]$contributors$target$history$edges[[1]]$node
      [[3]]$contributors$target$history$edges[[1]]$node$committer
      [[3]]$contributors$target$history$edges[[1]]$node$committer$user
      [[3]]$contributors$target$history$edges[[1]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[1]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[2]]
      [[3]]$contributors$target$history$edges[[2]]$node
      [[3]]$contributors$target$history$edges[[2]]$node$committer
      [[3]]$contributors$target$history$edges[[2]]$node$committer$user
      NULL
      
      
      
      
      [[3]]$contributors$target$history$edges[[3]]
      [[3]]$contributors$target$history$edges[[3]]$node
      [[3]]$contributors$target$history$edges[[3]]$node$committer
      [[3]]$contributors$target$history$edges[[3]]$node$committer$user
      [[3]]$contributors$target$history$edges[[3]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[3]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[4]]
      [[3]]$contributors$target$history$edges[[4]]$node
      [[3]]$contributors$target$history$edges[[4]]$node$committer
      [[3]]$contributors$target$history$edges[[4]]$node$committer$user
      [[3]]$contributors$target$history$edges[[4]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[4]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[5]]
      [[3]]$contributors$target$history$edges[[5]]$node
      [[3]]$contributors$target$history$edges[[5]]$node$committer
      [[3]]$contributors$target$history$edges[[5]]$node$committer$user
      [[3]]$contributors$target$history$edges[[5]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[5]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[6]]
      [[3]]$contributors$target$history$edges[[6]]$node
      [[3]]$contributors$target$history$edges[[6]]$node$committer
      [[3]]$contributors$target$history$edges[[6]]$node$committer$user
      [[3]]$contributors$target$history$edges[[6]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[6]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[7]]
      [[3]]$contributors$target$history$edges[[7]]$node
      [[3]]$contributors$target$history$edges[[7]]$node$committer
      [[3]]$contributors$target$history$edges[[7]]$node$committer$user
      NULL
      
      
      
      
      [[3]]$contributors$target$history$edges[[8]]
      [[3]]$contributors$target$history$edges[[8]]$node
      [[3]]$contributors$target$history$edges[[8]]$node$committer
      [[3]]$contributors$target$history$edges[[8]]$node$committer$user
      [[3]]$contributors$target$history$edges[[8]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[8]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[9]]
      [[3]]$contributors$target$history$edges[[9]]$node
      [[3]]$contributors$target$history$edges[[9]]$node$committer
      [[3]]$contributors$target$history$edges[[9]]$node$committer$user
      [[3]]$contributors$target$history$edges[[9]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[9]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[10]]
      [[3]]$contributors$target$history$edges[[10]]$node
      [[3]]$contributors$target$history$edges[[10]]$node$committer
      [[3]]$contributors$target$history$edges[[10]]$node$committer$user
      [[3]]$contributors$target$history$edges[[10]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[10]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[11]]
      [[3]]$contributors$target$history$edges[[11]]$node
      [[3]]$contributors$target$history$edges[[11]]$node$committer
      [[3]]$contributors$target$history$edges[[11]]$node$committer$user
      NULL
      
      
      
      
      [[3]]$contributors$target$history$edges[[12]]
      [[3]]$contributors$target$history$edges[[12]]$node
      [[3]]$contributors$target$history$edges[[12]]$node$committer
      [[3]]$contributors$target$history$edges[[12]]$node$committer$user
      [[3]]$contributors$target$history$edges[[12]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[12]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[13]]
      [[3]]$contributors$target$history$edges[[13]]$node
      [[3]]$contributors$target$history$edges[[13]]$node$committer
      [[3]]$contributors$target$history$edges[[13]]$node$committer$user
      [[3]]$contributors$target$history$edges[[13]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[13]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[14]]
      [[3]]$contributors$target$history$edges[[14]]$node
      [[3]]$contributors$target$history$edges[[14]]$node$committer
      [[3]]$contributors$target$history$edges[[14]]$node$committer$user
      [[3]]$contributors$target$history$edges[[14]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[14]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[15]]
      [[3]]$contributors$target$history$edges[[15]]$node
      [[3]]$contributors$target$history$edges[[15]]$node$committer
      [[3]]$contributors$target$history$edges[[15]]$node$committer$user
      [[3]]$contributors$target$history$edges[[15]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[15]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[16]]
      [[3]]$contributors$target$history$edges[[16]]$node
      [[3]]$contributors$target$history$edges[[16]]$node$committer
      [[3]]$contributors$target$history$edges[[16]]$node$committer$user
      [[3]]$contributors$target$history$edges[[16]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[16]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[17]]
      [[3]]$contributors$target$history$edges[[17]]$node
      [[3]]$contributors$target$history$edges[[17]]$node$committer
      [[3]]$contributors$target$history$edges[[17]]$node$committer$user
      NULL
      
      
      
      
      [[3]]$contributors$target$history$edges[[18]]
      [[3]]$contributors$target$history$edges[[18]]$node
      [[3]]$contributors$target$history$edges[[18]]$node$committer
      [[3]]$contributors$target$history$edges[[18]]$node$committer$user
      [[3]]$contributors$target$history$edges[[18]]$node$committer$user$login
      [1] "galachad"
      
      [[3]]$contributors$target$history$edges[[18]]$node$committer$user$id
      [1] "MDQ6VXNlcjQyOTYzOTA="
      ...
      [[3]]$contributors$target$history$edges[[19]]
      [[3]]$contributors$target$history$edges[[19]]$node
      [[3]]$contributors$target$history$edges[[19]]$node$committer
      [[3]]$contributors$target$history$edges[[19]]$node$committer$user
      NULL
      
      
      
      
      [[3]]$contributors$target$history$edges[[20]]
      [[3]]$contributors$target$history$edges[[20]]$node
      [[3]]$contributors$target$history$edges[[20]]$node$committer
      [[3]]$contributors$target$history$edges[[20]]$node$committer$user
      NULL
      
      
      
      
      [[3]]$contributors$target$history$edges[[21]]
      [[3]]$contributors$target$history$edges[[21]]$node
      [[3]]$contributors$target$history$edges[[21]]$node$committer
      [[3]]$contributors$target$history$edges[[21]]$node$committer$user
      NULL
      
      
      
      
      [[3]]$contributors$target$history$edges[[22]]
      [[3]]$contributors$target$history$edges[[22]]$node
      [[3]]$contributors$target$history$edges[[22]]$node$committer
      [[3]]$contributors$target$history$edges[[22]]$node$committer$user
      [[3]]$contributors$target$history$edges[[22]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[22]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[23]]
      [[3]]$contributors$target$history$edges[[23]]$node
      [[3]]$contributors$target$history$edges[[23]]$node$committer
      [[3]]$contributors$target$history$edges[[23]]$node$committer$user
      [[3]]$contributors$target$history$edges[[23]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[23]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[24]]
      [[3]]$contributors$target$history$edges[[24]]$node
      [[3]]$contributors$target$history$edges[[24]]$node$committer
      [[3]]$contributors$target$history$edges[[24]]$node$committer$user
      [[3]]$contributors$target$history$edges[[24]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[24]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[25]]
      [[3]]$contributors$target$history$edges[[25]]$node
      [[3]]$contributors$target$history$edges[[25]]$node$committer
      [[3]]$contributors$target$history$edges[[25]]$node$committer$user
      [[3]]$contributors$target$history$edges[[25]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[25]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[26]]
      [[3]]$contributors$target$history$edges[[26]]$node
      [[3]]$contributors$target$history$edges[[26]]$node$committer
      [[3]]$contributors$target$history$edges[[26]]$node$committer$user
      NULL
      
      
      
      
      [[3]]$contributors$target$history$edges[[27]]
      [[3]]$contributors$target$history$edges[[27]]$node
      [[3]]$contributors$target$history$edges[[27]]$node$committer
      [[3]]$contributors$target$history$edges[[27]]$node$committer$user
      [[3]]$contributors$target$history$edges[[27]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[27]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[28]]
      [[3]]$contributors$target$history$edges[[28]]$node
      [[3]]$contributors$target$history$edges[[28]]$node$committer
      [[3]]$contributors$target$history$edges[[28]]$node$committer$user
      [[3]]$contributors$target$history$edges[[28]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[28]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[29]]
      [[3]]$contributors$target$history$edges[[29]]$node
      [[3]]$contributors$target$history$edges[[29]]$node$committer
      [[3]]$contributors$target$history$edges[[29]]$node$committer$user
      [[3]]$contributors$target$history$edges[[29]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[29]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[30]]
      [[3]]$contributors$target$history$edges[[30]]$node
      [[3]]$contributors$target$history$edges[[30]]$node$committer
      [[3]]$contributors$target$history$edges[[30]]$node$committer$user
      [[3]]$contributors$target$history$edges[[30]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[30]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[31]]
      [[3]]$contributors$target$history$edges[[31]]$node
      [[3]]$contributors$target$history$edges[[31]]$node$committer
      [[3]]$contributors$target$history$edges[[31]]$node$committer$user
      [[3]]$contributors$target$history$edges[[31]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[31]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[32]]
      [[3]]$contributors$target$history$edges[[32]]$node
      [[3]]$contributors$target$history$edges[[32]]$node$committer
      [[3]]$contributors$target$history$edges[[32]]$node$committer$user
      [[3]]$contributors$target$history$edges[[32]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[32]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[33]]
      [[3]]$contributors$target$history$edges[[33]]$node
      [[3]]$contributors$target$history$edges[[33]]$node$committer
      [[3]]$contributors$target$history$edges[[33]]$node$committer$user
      [[3]]$contributors$target$history$edges[[33]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[33]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[34]]
      [[3]]$contributors$target$history$edges[[34]]$node
      [[3]]$contributors$target$history$edges[[34]]$node$committer
      [[3]]$contributors$target$history$edges[[34]]$node$committer$user
      [[3]]$contributors$target$history$edges[[34]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[34]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[35]]
      [[3]]$contributors$target$history$edges[[35]]$node
      [[3]]$contributors$target$history$edges[[35]]$node$committer
      [[3]]$contributors$target$history$edges[[35]]$node$committer$user
      [[3]]$contributors$target$history$edges[[35]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[35]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[36]]
      [[3]]$contributors$target$history$edges[[36]]$node
      [[3]]$contributors$target$history$edges[[36]]$node$committer
      [[3]]$contributors$target$history$edges[[36]]$node$committer$user
      [[3]]$contributors$target$history$edges[[36]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[36]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[37]]
      [[3]]$contributors$target$history$edges[[37]]$node
      [[3]]$contributors$target$history$edges[[37]]$node$committer
      [[3]]$contributors$target$history$edges[[37]]$node$committer$user
      [[3]]$contributors$target$history$edges[[37]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[37]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[38]]
      [[3]]$contributors$target$history$edges[[38]]$node
      [[3]]$contributors$target$history$edges[[38]]$node$committer
      [[3]]$contributors$target$history$edges[[38]]$node$committer$user
      [[3]]$contributors$target$history$edges[[38]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[38]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[39]]
      [[3]]$contributors$target$history$edges[[39]]$node
      [[3]]$contributors$target$history$edges[[39]]$node$committer
      [[3]]$contributors$target$history$edges[[39]]$node$committer$user
      [[3]]$contributors$target$history$edges[[39]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[39]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[40]]
      [[3]]$contributors$target$history$edges[[40]]$node
      [[3]]$contributors$target$history$edges[[40]]$node$committer
      [[3]]$contributors$target$history$edges[[40]]$node$committer$user
      [[3]]$contributors$target$history$edges[[40]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[40]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[41]]
      [[3]]$contributors$target$history$edges[[41]]$node
      [[3]]$contributors$target$history$edges[[41]]$node$committer
      [[3]]$contributors$target$history$edges[[41]]$node$committer$user
      [[3]]$contributors$target$history$edges[[41]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[41]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[42]]
      [[3]]$contributors$target$history$edges[[42]]$node
      [[3]]$contributors$target$history$edges[[42]]$node$committer
      [[3]]$contributors$target$history$edges[[42]]$node$committer$user
      [[3]]$contributors$target$history$edges[[42]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[42]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[43]]
      [[3]]$contributors$target$history$edges[[43]]$node
      [[3]]$contributors$target$history$edges[[43]]$node$committer
      [[3]]$contributors$target$history$edges[[43]]$node$committer$user
      [[3]]$contributors$target$history$edges[[43]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[43]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[44]]
      [[3]]$contributors$target$history$edges[[44]]$node
      [[3]]$contributors$target$history$edges[[44]]$node$committer
      [[3]]$contributors$target$history$edges[[44]]$node$committer$user
      [[3]]$contributors$target$history$edges[[44]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[44]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[45]]
      [[3]]$contributors$target$history$edges[[45]]$node
      [[3]]$contributors$target$history$edges[[45]]$node$committer
      [[3]]$contributors$target$history$edges[[45]]$node$committer$user
      [[3]]$contributors$target$history$edges[[45]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[45]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[46]]
      [[3]]$contributors$target$history$edges[[46]]$node
      [[3]]$contributors$target$history$edges[[46]]$node$committer
      [[3]]$contributors$target$history$edges[[46]]$node$committer$user
      [[3]]$contributors$target$history$edges[[46]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[46]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[47]]
      [[3]]$contributors$target$history$edges[[47]]$node
      [[3]]$contributors$target$history$edges[[47]]$node$committer
      [[3]]$contributors$target$history$edges[[47]]$node$committer$user
      [[3]]$contributors$target$history$edges[[47]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[47]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[48]]
      [[3]]$contributors$target$history$edges[[48]]$node
      [[3]]$contributors$target$history$edges[[48]]$node$committer
      [[3]]$contributors$target$history$edges[[48]]$node$committer$user
      [[3]]$contributors$target$history$edges[[48]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[48]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[49]]
      [[3]]$contributors$target$history$edges[[49]]$node
      [[3]]$contributors$target$history$edges[[49]]$node$committer
      [[3]]$contributors$target$history$edges[[49]]$node$committer$user
      [[3]]$contributors$target$history$edges[[49]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[49]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[50]]
      [[3]]$contributors$target$history$edges[[50]]$node
      [[3]]$contributors$target$history$edges[[50]]$node$committer
      [[3]]$contributors$target$history$edges[[50]]$node$committer$user
      [[3]]$contributors$target$history$edges[[50]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[50]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[51]]
      [[3]]$contributors$target$history$edges[[51]]$node
      [[3]]$contributors$target$history$edges[[51]]$node$committer
      [[3]]$contributors$target$history$edges[[51]]$node$committer$user
      [[3]]$contributors$target$history$edges[[51]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[51]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[3]]$contributors$target$history$edges[[52]]
      [[3]]$contributors$target$history$edges[[52]]$node
      [[3]]$contributors$target$history$edges[[52]]$node$committer
      [[3]]$contributors$target$history$edges[[52]]$node$committer$user
      [[3]]$contributors$target$history$edges[[52]]$node$committer$user$login
      [1] "galachad"
      
      [[3]]$contributors$target$history$edges[[52]]$node$committer$user$id
      [1] "MDQ6VXNlcjQyOTYzOTA="
      ...
      [[3]]$contributors$target$history$edges[[53]]
      [[3]]$contributors$target$history$edges[[53]]$node
      [[3]]$contributors$target$history$edges[[53]]$node$committer
      [[3]]$contributors$target$history$edges[[53]]$node$committer$user
      NULL
      
      
      
      
      [[3]]$contributors$target$history$edges[[54]]
      [[3]]$contributors$target$history$edges[[54]]$node
      [[3]]$contributors$target$history$edges[[54]]$node$committer
      [[3]]$contributors$target$history$edges[[54]]$node$committer$user
      [[3]]$contributors$target$history$edges[[54]]$node$committer$user$login
      [1] "galachad"
      
      [[3]]$contributors$target$history$edges[[54]]$node$committer$user$id
      [1] "MDQ6VXNlcjQyOTYzOTA="
      ...
      [[3]]$contributors$target$history$edges[[55]]
      [[3]]$contributors$target$history$edges[[55]]$node
      [[3]]$contributors$target$history$edges[[55]]$node$committer
      [[3]]$contributors$target$history$edges[[55]]$node$committer$user
      NULL
      
      
      
      
      [[3]]$contributors$target$history$edges[[56]]
      [[3]]$contributors$target$history$edges[[56]]$node
      [[3]]$contributors$target$history$edges[[56]]$node$committer
      [[3]]$contributors$target$history$edges[[56]]$node$committer$user
      [[3]]$contributors$target$history$edges[[56]]$node$committer$user$login
      [1] "galachad"
      
      [[3]]$contributors$target$history$edges[[56]]$node$committer$user$id
      [1] "MDQ6VXNlcjQyOTYzOTA="
      ...
      [[3]]$contributors$target$history$edges[[57]]
      [[3]]$contributors$target$history$edges[[57]]$node
      [[3]]$contributors$target$history$edges[[57]]$node$committer
      [[3]]$contributors$target$history$edges[[57]]$node$committer$user
      [[3]]$contributors$target$history$edges[[57]]$node$committer$user$login
      [1] "galachad"
      
      [[3]]$contributors$target$history$edges[[57]]$node$committer$user$id
      [1] "MDQ6VXNlcjQyOTYzOTA="
      ...
      [[3]]$contributors$target$history$edges[[58]]
      [[3]]$contributors$target$history$edges[[58]]$node
      [[3]]$contributors$target$history$edges[[58]]$node$committer
      [[3]]$contributors$target$history$edges[[58]]$node$committer$user
      NULL
      
      
      
      
      [[3]]$contributors$target$history$edges[[59]]
      [[3]]$contributors$target$history$edges[[59]]$node
      [[3]]$contributors$target$history$edges[[59]]$node$committer
      [[3]]$contributors$target$history$edges[[59]]$node$committer$user
      [[3]]$contributors$target$history$edges[[59]]$node$committer$user$login
      [1] "galachad"
      
      [[3]]$contributors$target$history$edges[[59]]$node$committer$user$id
      [1] "MDQ6VXNlcjQyOTYzOTA="
      ...
      [[3]]$contributors$target$history$edges[[60]]
      [[3]]$contributors$target$history$edges[[60]]$node
      [[3]]$contributors$target$history$edges[[60]]$node$committer
      [[3]]$contributors$target$history$edges[[60]]$node$committer$user
      [[3]]$contributors$target$history$edges[[60]]$node$committer$user$login
      [1] "galachad"
      
      [[3]]$contributors$target$history$edges[[60]]$node$committer$user$id
      [1] "MDQ6VXNlcjQyOTYzOTA="
      ...
      [[3]]$contributors$target$history$edges[[61]]
      [[3]]$contributors$target$history$edges[[61]]$node
      [[3]]$contributors$target$history$edges[[61]]$node$committer
      [[3]]$contributors$target$history$edges[[61]]$node$committer$user
      [[3]]$contributors$target$history$edges[[61]]$node$committer$user$login
      [1] "galachad"
      
      [[3]]$contributors$target$history$edges[[61]]$node$committer$user$id
      [1] "MDQ6VXNlcjQyOTYzOTA="
      ...
      [[3]]$contributors$target$history$edges[[62]]
      [[3]]$contributors$target$history$edges[[62]]$node
      [[3]]$contributors$target$history$edges[[62]]$node$committer
      [[3]]$contributors$target$history$edges[[62]]$node$committer$user
      [[3]]$contributors$target$history$edges[[62]]$node$committer$user$login
      [1] "galachad"
      
      [[3]]$contributors$target$history$edges[[62]]$node$committer$user$id
      [1] "MDQ6VXNlcjQyOTYzOTA="
      ...
      [[3]]$contributors$target$history$edges[[63]]
      [[3]]$contributors$target$history$edges[[63]]$node
      [[3]]$contributors$target$history$edges[[63]]$node$committer
      [[3]]$contributors$target$history$edges[[63]]$node$committer$user
      [[3]]$contributors$target$history$edges[[63]]$node$committer$user$login
      [1] "galachad"
      
      [[3]]$contributors$target$history$edges[[63]]$node$committer$user$id
      [1] "MDQ6VXNlcjQyOTYzOTA="
      ...
      [[3]]$contributors$target$history$edges[[64]]
      [[3]]$contributors$target$history$edges[[64]]$node
      [[3]]$contributors$target$history$edges[[64]]$node$committer
      [[3]]$contributors$target$history$edges[[64]]$node$committer$user
      [[3]]$contributors$target$history$edges[[64]]$node$committer$user$login
      [1] "krystian8207"
      
      [[3]]$contributors$target$history$edges[[64]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[4]]$issues_open
      [[4]]$issues_open$totalCount
      [1] 3
      
      
      [[4]]$issues_closed
      [[4]]$issues_closed$totalCount
      [1] 0
      
      
      [[4]]$contributors
      [[4]]$contributors$target
      [[4]]$contributors$target$id
      [1] "C_kwDOHYNxt9oAKGQzYzY5NGM5Y2Q4NjY2ODhmNmQ0ODQzMTVjNzRlNDNjZGZiNGRlZTI"
      
      [[4]]$contributors$target$history
      [[4]]$contributors$target$history$edges
      [[4]]$contributors$target$history$edges[[1]]
      [[4]]$contributors$target$history$edges[[1]]$node
      [[4]]$contributors$target$history$edges[[1]]$node$committer
      [[4]]$contributors$target$history$edges[[1]]$node$committer$user
      [[4]]$contributors$target$history$edges[[1]]$node$committer$user$login
      [1] "krystian8207"
      
      [[4]]$contributors$target$history$edges[[1]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[5]]$issues_open
      [[5]]$issues_open$totalCount
      [1] 57
      
      
      [[5]]$issues_closed
      [[5]]$issues_closed$totalCount
      [1] 69
      
      
      [[5]]$contributors
      [[5]]$contributors$target
      [[5]]$contributors$target$id
      [1] "C_kwDOIvtxstoAKGVmMGViNzczNzFkMWM1MWE1NTcxOTgxNTE4YTI2MzAzY2IxMzYzZWU"
      
      [[5]]$contributors$target$history
      [[5]]$contributors$target$history$edges
      [[5]]$contributors$target$history$edges[[1]]
      [[5]]$contributors$target$history$edges[[1]]$node
      [[5]]$contributors$target$history$edges[[1]]$node$committer
      [[5]]$contributors$target$history$edges[[1]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[2]]
      [[5]]$contributors$target$history$edges[[2]]$node
      [[5]]$contributors$target$history$edges[[2]]$node$committer
      [[5]]$contributors$target$history$edges[[2]]$node$committer$user
      [[5]]$contributors$target$history$edges[[2]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[2]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[3]]
      [[5]]$contributors$target$history$edges[[3]]$node
      [[5]]$contributors$target$history$edges[[3]]$node$committer
      [[5]]$contributors$target$history$edges[[3]]$node$committer$user
      [[5]]$contributors$target$history$edges[[3]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[3]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[4]]
      [[5]]$contributors$target$history$edges[[4]]$node
      [[5]]$contributors$target$history$edges[[4]]$node$committer
      [[5]]$contributors$target$history$edges[[4]]$node$committer$user
      [[5]]$contributors$target$history$edges[[4]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[4]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[5]]
      [[5]]$contributors$target$history$edges[[5]]$node
      [[5]]$contributors$target$history$edges[[5]]$node$committer
      [[5]]$contributors$target$history$edges[[5]]$node$committer$user
      [[5]]$contributors$target$history$edges[[5]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[5]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[6]]
      [[5]]$contributors$target$history$edges[[6]]$node
      [[5]]$contributors$target$history$edges[[6]]$node$committer
      [[5]]$contributors$target$history$edges[[6]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[7]]
      [[5]]$contributors$target$history$edges[[7]]$node
      [[5]]$contributors$target$history$edges[[7]]$node$committer
      [[5]]$contributors$target$history$edges[[7]]$node$committer$user
      [[5]]$contributors$target$history$edges[[7]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[7]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[8]]
      [[5]]$contributors$target$history$edges[[8]]$node
      [[5]]$contributors$target$history$edges[[8]]$node$committer
      [[5]]$contributors$target$history$edges[[8]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[9]]
      [[5]]$contributors$target$history$edges[[9]]$node
      [[5]]$contributors$target$history$edges[[9]]$node$committer
      [[5]]$contributors$target$history$edges[[9]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[10]]
      [[5]]$contributors$target$history$edges[[10]]$node
      [[5]]$contributors$target$history$edges[[10]]$node$committer
      [[5]]$contributors$target$history$edges[[10]]$node$committer$user
      [[5]]$contributors$target$history$edges[[10]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[10]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[11]]
      [[5]]$contributors$target$history$edges[[11]]$node
      [[5]]$contributors$target$history$edges[[11]]$node$committer
      [[5]]$contributors$target$history$edges[[11]]$node$committer$user
      [[5]]$contributors$target$history$edges[[11]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[11]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[12]]
      [[5]]$contributors$target$history$edges[[12]]$node
      [[5]]$contributors$target$history$edges[[12]]$node$committer
      [[5]]$contributors$target$history$edges[[12]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[13]]
      [[5]]$contributors$target$history$edges[[13]]$node
      [[5]]$contributors$target$history$edges[[13]]$node$committer
      [[5]]$contributors$target$history$edges[[13]]$node$committer$user
      [[5]]$contributors$target$history$edges[[13]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[13]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[14]]
      [[5]]$contributors$target$history$edges[[14]]$node
      [[5]]$contributors$target$history$edges[[14]]$node$committer
      [[5]]$contributors$target$history$edges[[14]]$node$committer$user
      [[5]]$contributors$target$history$edges[[14]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[14]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[15]]
      [[5]]$contributors$target$history$edges[[15]]$node
      [[5]]$contributors$target$history$edges[[15]]$node$committer
      [[5]]$contributors$target$history$edges[[15]]$node$committer$user
      [[5]]$contributors$target$history$edges[[15]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[15]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[16]]
      [[5]]$contributors$target$history$edges[[16]]$node
      [[5]]$contributors$target$history$edges[[16]]$node$committer
      [[5]]$contributors$target$history$edges[[16]]$node$committer$user
      [[5]]$contributors$target$history$edges[[16]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[16]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[17]]
      [[5]]$contributors$target$history$edges[[17]]$node
      [[5]]$contributors$target$history$edges[[17]]$node$committer
      [[5]]$contributors$target$history$edges[[17]]$node$committer$user
      [[5]]$contributors$target$history$edges[[17]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[17]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[18]]
      [[5]]$contributors$target$history$edges[[18]]$node
      [[5]]$contributors$target$history$edges[[18]]$node$committer
      [[5]]$contributors$target$history$edges[[18]]$node$committer$user
      [[5]]$contributors$target$history$edges[[18]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[18]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[19]]
      [[5]]$contributors$target$history$edges[[19]]$node
      [[5]]$contributors$target$history$edges[[19]]$node$committer
      [[5]]$contributors$target$history$edges[[19]]$node$committer$user
      [[5]]$contributors$target$history$edges[[19]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[19]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[20]]
      [[5]]$contributors$target$history$edges[[20]]$node
      [[5]]$contributors$target$history$edges[[20]]$node$committer
      [[5]]$contributors$target$history$edges[[20]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[21]]
      [[5]]$contributors$target$history$edges[[21]]$node
      [[5]]$contributors$target$history$edges[[21]]$node$committer
      [[5]]$contributors$target$history$edges[[21]]$node$committer$user
      [[5]]$contributors$target$history$edges[[21]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[21]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[22]]
      [[5]]$contributors$target$history$edges[[22]]$node
      [[5]]$contributors$target$history$edges[[22]]$node$committer
      [[5]]$contributors$target$history$edges[[22]]$node$committer$user
      [[5]]$contributors$target$history$edges[[22]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[22]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[23]]
      [[5]]$contributors$target$history$edges[[23]]$node
      [[5]]$contributors$target$history$edges[[23]]$node$committer
      [[5]]$contributors$target$history$edges[[23]]$node$committer$user
      [[5]]$contributors$target$history$edges[[23]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[23]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[24]]
      [[5]]$contributors$target$history$edges[[24]]$node
      [[5]]$contributors$target$history$edges[[24]]$node$committer
      [[5]]$contributors$target$history$edges[[24]]$node$committer$user
      [[5]]$contributors$target$history$edges[[24]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[24]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[25]]
      [[5]]$contributors$target$history$edges[[25]]$node
      [[5]]$contributors$target$history$edges[[25]]$node$committer
      [[5]]$contributors$target$history$edges[[25]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[26]]
      [[5]]$contributors$target$history$edges[[26]]$node
      [[5]]$contributors$target$history$edges[[26]]$node$committer
      [[5]]$contributors$target$history$edges[[26]]$node$committer$user
      [[5]]$contributors$target$history$edges[[26]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[26]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[27]]
      [[5]]$contributors$target$history$edges[[27]]$node
      [[5]]$contributors$target$history$edges[[27]]$node$committer
      [[5]]$contributors$target$history$edges[[27]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[28]]
      [[5]]$contributors$target$history$edges[[28]]$node
      [[5]]$contributors$target$history$edges[[28]]$node$committer
      [[5]]$contributors$target$history$edges[[28]]$node$committer$user
      [[5]]$contributors$target$history$edges[[28]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[28]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[29]]
      [[5]]$contributors$target$history$edges[[29]]$node
      [[5]]$contributors$target$history$edges[[29]]$node$committer
      [[5]]$contributors$target$history$edges[[29]]$node$committer$user
      [[5]]$contributors$target$history$edges[[29]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[29]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[30]]
      [[5]]$contributors$target$history$edges[[30]]$node
      [[5]]$contributors$target$history$edges[[30]]$node$committer
      [[5]]$contributors$target$history$edges[[30]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[31]]
      [[5]]$contributors$target$history$edges[[31]]$node
      [[5]]$contributors$target$history$edges[[31]]$node$committer
      [[5]]$contributors$target$history$edges[[31]]$node$committer$user
      [[5]]$contributors$target$history$edges[[31]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[31]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[32]]
      [[5]]$contributors$target$history$edges[[32]]$node
      [[5]]$contributors$target$history$edges[[32]]$node$committer
      [[5]]$contributors$target$history$edges[[32]]$node$committer$user
      [[5]]$contributors$target$history$edges[[32]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[32]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[33]]
      [[5]]$contributors$target$history$edges[[33]]$node
      [[5]]$contributors$target$history$edges[[33]]$node$committer
      [[5]]$contributors$target$history$edges[[33]]$node$committer$user
      [[5]]$contributors$target$history$edges[[33]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[33]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[34]]
      [[5]]$contributors$target$history$edges[[34]]$node
      [[5]]$contributors$target$history$edges[[34]]$node$committer
      [[5]]$contributors$target$history$edges[[34]]$node$committer$user
      [[5]]$contributors$target$history$edges[[34]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[34]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[35]]
      [[5]]$contributors$target$history$edges[[35]]$node
      [[5]]$contributors$target$history$edges[[35]]$node$committer
      [[5]]$contributors$target$history$edges[[35]]$node$committer$user
      [[5]]$contributors$target$history$edges[[35]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[35]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[36]]
      [[5]]$contributors$target$history$edges[[36]]$node
      [[5]]$contributors$target$history$edges[[36]]$node$committer
      [[5]]$contributors$target$history$edges[[36]]$node$committer$user
      [[5]]$contributors$target$history$edges[[36]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[36]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[37]]
      [[5]]$contributors$target$history$edges[[37]]$node
      [[5]]$contributors$target$history$edges[[37]]$node$committer
      [[5]]$contributors$target$history$edges[[37]]$node$committer$user
      [[5]]$contributors$target$history$edges[[37]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[37]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[38]]
      [[5]]$contributors$target$history$edges[[38]]$node
      [[5]]$contributors$target$history$edges[[38]]$node$committer
      [[5]]$contributors$target$history$edges[[38]]$node$committer$user
      [[5]]$contributors$target$history$edges[[38]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[38]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[39]]
      [[5]]$contributors$target$history$edges[[39]]$node
      [[5]]$contributors$target$history$edges[[39]]$node$committer
      [[5]]$contributors$target$history$edges[[39]]$node$committer$user
      [[5]]$contributors$target$history$edges[[39]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[39]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[40]]
      [[5]]$contributors$target$history$edges[[40]]$node
      [[5]]$contributors$target$history$edges[[40]]$node$committer
      [[5]]$contributors$target$history$edges[[40]]$node$committer$user
      [[5]]$contributors$target$history$edges[[40]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[40]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[41]]
      [[5]]$contributors$target$history$edges[[41]]$node
      [[5]]$contributors$target$history$edges[[41]]$node$committer
      [[5]]$contributors$target$history$edges[[41]]$node$committer$user
      [[5]]$contributors$target$history$edges[[41]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[41]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[42]]
      [[5]]$contributors$target$history$edges[[42]]$node
      [[5]]$contributors$target$history$edges[[42]]$node$committer
      [[5]]$contributors$target$history$edges[[42]]$node$committer$user
      [[5]]$contributors$target$history$edges[[42]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[42]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[43]]
      [[5]]$contributors$target$history$edges[[43]]$node
      [[5]]$contributors$target$history$edges[[43]]$node$committer
      [[5]]$contributors$target$history$edges[[43]]$node$committer$user
      [[5]]$contributors$target$history$edges[[43]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[43]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[44]]
      [[5]]$contributors$target$history$edges[[44]]$node
      [[5]]$contributors$target$history$edges[[44]]$node$committer
      [[5]]$contributors$target$history$edges[[44]]$node$committer$user
      [[5]]$contributors$target$history$edges[[44]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[44]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[45]]
      [[5]]$contributors$target$history$edges[[45]]$node
      [[5]]$contributors$target$history$edges[[45]]$node$committer
      [[5]]$contributors$target$history$edges[[45]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[46]]
      [[5]]$contributors$target$history$edges[[46]]$node
      [[5]]$contributors$target$history$edges[[46]]$node$committer
      [[5]]$contributors$target$history$edges[[46]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[47]]
      [[5]]$contributors$target$history$edges[[47]]$node
      [[5]]$contributors$target$history$edges[[47]]$node$committer
      [[5]]$contributors$target$history$edges[[47]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[48]]
      [[5]]$contributors$target$history$edges[[48]]$node
      [[5]]$contributors$target$history$edges[[48]]$node$committer
      [[5]]$contributors$target$history$edges[[48]]$node$committer$user
      [[5]]$contributors$target$history$edges[[48]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[48]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[49]]
      [[5]]$contributors$target$history$edges[[49]]$node
      [[5]]$contributors$target$history$edges[[49]]$node$committer
      [[5]]$contributors$target$history$edges[[49]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[50]]
      [[5]]$contributors$target$history$edges[[50]]$node
      [[5]]$contributors$target$history$edges[[50]]$node$committer
      [[5]]$contributors$target$history$edges[[50]]$node$committer$user
      [[5]]$contributors$target$history$edges[[50]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[50]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[51]]
      [[5]]$contributors$target$history$edges[[51]]$node
      [[5]]$contributors$target$history$edges[[51]]$node$committer
      [[5]]$contributors$target$history$edges[[51]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[52]]
      [[5]]$contributors$target$history$edges[[52]]$node
      [[5]]$contributors$target$history$edges[[52]]$node$committer
      [[5]]$contributors$target$history$edges[[52]]$node$committer$user
      [[5]]$contributors$target$history$edges[[52]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[52]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[53]]
      [[5]]$contributors$target$history$edges[[53]]$node
      [[5]]$contributors$target$history$edges[[53]]$node$committer
      [[5]]$contributors$target$history$edges[[53]]$node$committer$user
      [[5]]$contributors$target$history$edges[[53]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[53]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[54]]
      [[5]]$contributors$target$history$edges[[54]]$node
      [[5]]$contributors$target$history$edges[[54]]$node$committer
      [[5]]$contributors$target$history$edges[[54]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[55]]
      [[5]]$contributors$target$history$edges[[55]]$node
      [[5]]$contributors$target$history$edges[[55]]$node$committer
      [[5]]$contributors$target$history$edges[[55]]$node$committer$user
      [[5]]$contributors$target$history$edges[[55]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[55]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[56]]
      [[5]]$contributors$target$history$edges[[56]]$node
      [[5]]$contributors$target$history$edges[[56]]$node$committer
      [[5]]$contributors$target$history$edges[[56]]$node$committer$user
      [[5]]$contributors$target$history$edges[[56]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[56]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[57]]
      [[5]]$contributors$target$history$edges[[57]]$node
      [[5]]$contributors$target$history$edges[[57]]$node$committer
      [[5]]$contributors$target$history$edges[[57]]$node$committer$user
      [[5]]$contributors$target$history$edges[[57]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[57]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[58]]
      [[5]]$contributors$target$history$edges[[58]]$node
      [[5]]$contributors$target$history$edges[[58]]$node$committer
      [[5]]$contributors$target$history$edges[[58]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[59]]
      [[5]]$contributors$target$history$edges[[59]]$node
      [[5]]$contributors$target$history$edges[[59]]$node$committer
      [[5]]$contributors$target$history$edges[[59]]$node$committer$user
      [[5]]$contributors$target$history$edges[[59]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[59]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[60]]
      [[5]]$contributors$target$history$edges[[60]]$node
      [[5]]$contributors$target$history$edges[[60]]$node$committer
      [[5]]$contributors$target$history$edges[[60]]$node$committer$user
      [[5]]$contributors$target$history$edges[[60]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[60]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[61]]
      [[5]]$contributors$target$history$edges[[61]]$node
      [[5]]$contributors$target$history$edges[[61]]$node$committer
      [[5]]$contributors$target$history$edges[[61]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[62]]
      [[5]]$contributors$target$history$edges[[62]]$node
      [[5]]$contributors$target$history$edges[[62]]$node$committer
      [[5]]$contributors$target$history$edges[[62]]$node$committer$user
      [[5]]$contributors$target$history$edges[[62]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[62]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[63]]
      [[5]]$contributors$target$history$edges[[63]]$node
      [[5]]$contributors$target$history$edges[[63]]$node$committer
      [[5]]$contributors$target$history$edges[[63]]$node$committer$user
      [[5]]$contributors$target$history$edges[[63]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[63]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[64]]
      [[5]]$contributors$target$history$edges[[64]]$node
      [[5]]$contributors$target$history$edges[[64]]$node$committer
      [[5]]$contributors$target$history$edges[[64]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[65]]
      [[5]]$contributors$target$history$edges[[65]]$node
      [[5]]$contributors$target$history$edges[[65]]$node$committer
      [[5]]$contributors$target$history$edges[[65]]$node$committer$user
      [[5]]$contributors$target$history$edges[[65]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[65]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[66]]
      [[5]]$contributors$target$history$edges[[66]]$node
      [[5]]$contributors$target$history$edges[[66]]$node$committer
      [[5]]$contributors$target$history$edges[[66]]$node$committer$user
      [[5]]$contributors$target$history$edges[[66]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[66]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[67]]
      [[5]]$contributors$target$history$edges[[67]]$node
      [[5]]$contributors$target$history$edges[[67]]$node$committer
      [[5]]$contributors$target$history$edges[[67]]$node$committer$user
      [[5]]$contributors$target$history$edges[[67]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[67]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[68]]
      [[5]]$contributors$target$history$edges[[68]]$node
      [[5]]$contributors$target$history$edges[[68]]$node$committer
      [[5]]$contributors$target$history$edges[[68]]$node$committer$user
      [[5]]$contributors$target$history$edges[[68]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[68]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[69]]
      [[5]]$contributors$target$history$edges[[69]]$node
      [[5]]$contributors$target$history$edges[[69]]$node$committer
      [[5]]$contributors$target$history$edges[[69]]$node$committer$user
      [[5]]$contributors$target$history$edges[[69]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[69]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[70]]
      [[5]]$contributors$target$history$edges[[70]]$node
      [[5]]$contributors$target$history$edges[[70]]$node$committer
      [[5]]$contributors$target$history$edges[[70]]$node$committer$user
      [[5]]$contributors$target$history$edges[[70]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[70]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[71]]
      [[5]]$contributors$target$history$edges[[71]]$node
      [[5]]$contributors$target$history$edges[[71]]$node$committer
      [[5]]$contributors$target$history$edges[[71]]$node$committer$user
      [[5]]$contributors$target$history$edges[[71]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[71]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[72]]
      [[5]]$contributors$target$history$edges[[72]]$node
      [[5]]$contributors$target$history$edges[[72]]$node$committer
      [[5]]$contributors$target$history$edges[[72]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[73]]
      [[5]]$contributors$target$history$edges[[73]]$node
      [[5]]$contributors$target$history$edges[[73]]$node$committer
      [[5]]$contributors$target$history$edges[[73]]$node$committer$user
      [[5]]$contributors$target$history$edges[[73]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[73]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[74]]
      [[5]]$contributors$target$history$edges[[74]]$node
      [[5]]$contributors$target$history$edges[[74]]$node$committer
      [[5]]$contributors$target$history$edges[[74]]$node$committer$user
      [[5]]$contributors$target$history$edges[[74]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[74]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[75]]
      [[5]]$contributors$target$history$edges[[75]]$node
      [[5]]$contributors$target$history$edges[[75]]$node$committer
      [[5]]$contributors$target$history$edges[[75]]$node$committer$user
      [[5]]$contributors$target$history$edges[[75]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[75]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[76]]
      [[5]]$contributors$target$history$edges[[76]]$node
      [[5]]$contributors$target$history$edges[[76]]$node$committer
      [[5]]$contributors$target$history$edges[[76]]$node$committer$user
      [[5]]$contributors$target$history$edges[[76]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[76]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[77]]
      [[5]]$contributors$target$history$edges[[77]]$node
      [[5]]$contributors$target$history$edges[[77]]$node$committer
      [[5]]$contributors$target$history$edges[[77]]$node$committer$user
      [[5]]$contributors$target$history$edges[[77]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[77]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[78]]
      [[5]]$contributors$target$history$edges[[78]]$node
      [[5]]$contributors$target$history$edges[[78]]$node$committer
      [[5]]$contributors$target$history$edges[[78]]$node$committer$user
      [[5]]$contributors$target$history$edges[[78]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[78]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[79]]
      [[5]]$contributors$target$history$edges[[79]]$node
      [[5]]$contributors$target$history$edges[[79]]$node$committer
      [[5]]$contributors$target$history$edges[[79]]$node$committer$user
      [[5]]$contributors$target$history$edges[[79]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[79]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[80]]
      [[5]]$contributors$target$history$edges[[80]]$node
      [[5]]$contributors$target$history$edges[[80]]$node$committer
      [[5]]$contributors$target$history$edges[[80]]$node$committer$user
      [[5]]$contributors$target$history$edges[[80]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[80]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[81]]
      [[5]]$contributors$target$history$edges[[81]]$node
      [[5]]$contributors$target$history$edges[[81]]$node$committer
      [[5]]$contributors$target$history$edges[[81]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[82]]
      [[5]]$contributors$target$history$edges[[82]]$node
      [[5]]$contributors$target$history$edges[[82]]$node$committer
      [[5]]$contributors$target$history$edges[[82]]$node$committer$user
      [[5]]$contributors$target$history$edges[[82]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[82]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[83]]
      [[5]]$contributors$target$history$edges[[83]]$node
      [[5]]$contributors$target$history$edges[[83]]$node$committer
      [[5]]$contributors$target$history$edges[[83]]$node$committer$user
      [[5]]$contributors$target$history$edges[[83]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[83]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[84]]
      [[5]]$contributors$target$history$edges[[84]]$node
      [[5]]$contributors$target$history$edges[[84]]$node$committer
      [[5]]$contributors$target$history$edges[[84]]$node$committer$user
      [[5]]$contributors$target$history$edges[[84]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[84]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[85]]
      [[5]]$contributors$target$history$edges[[85]]$node
      [[5]]$contributors$target$history$edges[[85]]$node$committer
      [[5]]$contributors$target$history$edges[[85]]$node$committer$user
      [[5]]$contributors$target$history$edges[[85]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[85]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[86]]
      [[5]]$contributors$target$history$edges[[86]]$node
      [[5]]$contributors$target$history$edges[[86]]$node$committer
      [[5]]$contributors$target$history$edges[[86]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[87]]
      [[5]]$contributors$target$history$edges[[87]]$node
      [[5]]$contributors$target$history$edges[[87]]$node$committer
      [[5]]$contributors$target$history$edges[[87]]$node$committer$user
      [[5]]$contributors$target$history$edges[[87]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[87]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[88]]
      [[5]]$contributors$target$history$edges[[88]]$node
      [[5]]$contributors$target$history$edges[[88]]$node$committer
      [[5]]$contributors$target$history$edges[[88]]$node$committer$user
      [[5]]$contributors$target$history$edges[[88]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[88]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[89]]
      [[5]]$contributors$target$history$edges[[89]]$node
      [[5]]$contributors$target$history$edges[[89]]$node$committer
      [[5]]$contributors$target$history$edges[[89]]$node$committer$user
      [[5]]$contributors$target$history$edges[[89]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[89]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[90]]
      [[5]]$contributors$target$history$edges[[90]]$node
      [[5]]$contributors$target$history$edges[[90]]$node$committer
      [[5]]$contributors$target$history$edges[[90]]$node$committer$user
      [[5]]$contributors$target$history$edges[[90]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[90]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[91]]
      [[5]]$contributors$target$history$edges[[91]]$node
      [[5]]$contributors$target$history$edges[[91]]$node$committer
      [[5]]$contributors$target$history$edges[[91]]$node$committer$user
      [[5]]$contributors$target$history$edges[[91]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[91]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[92]]
      [[5]]$contributors$target$history$edges[[92]]$node
      [[5]]$contributors$target$history$edges[[92]]$node$committer
      [[5]]$contributors$target$history$edges[[92]]$node$committer$user
      NULL
      
      
      
      
      [[5]]$contributors$target$history$edges[[93]]
      [[5]]$contributors$target$history$edges[[93]]$node
      [[5]]$contributors$target$history$edges[[93]]$node$committer
      [[5]]$contributors$target$history$edges[[93]]$node$committer$user
      [[5]]$contributors$target$history$edges[[93]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[93]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[94]]
      [[5]]$contributors$target$history$edges[[94]]$node
      [[5]]$contributors$target$history$edges[[94]]$node$committer
      [[5]]$contributors$target$history$edges[[94]]$node$committer$user
      [[5]]$contributors$target$history$edges[[94]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[94]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[95]]
      [[5]]$contributors$target$history$edges[[95]]$node
      [[5]]$contributors$target$history$edges[[95]]$node$committer
      [[5]]$contributors$target$history$edges[[95]]$node$committer$user
      [[5]]$contributors$target$history$edges[[95]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[95]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[96]]
      [[5]]$contributors$target$history$edges[[96]]$node
      [[5]]$contributors$target$history$edges[[96]]$node$committer
      [[5]]$contributors$target$history$edges[[96]]$node$committer$user
      [[5]]$contributors$target$history$edges[[96]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[96]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[97]]
      [[5]]$contributors$target$history$edges[[97]]$node
      [[5]]$contributors$target$history$edges[[97]]$node$committer
      [[5]]$contributors$target$history$edges[[97]]$node$committer$user
      [[5]]$contributors$target$history$edges[[97]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[97]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[98]]
      [[5]]$contributors$target$history$edges[[98]]$node
      [[5]]$contributors$target$history$edges[[98]]$node$committer
      [[5]]$contributors$target$history$edges[[98]]$node$committer$user
      [[5]]$contributors$target$history$edges[[98]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[98]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[99]]
      [[5]]$contributors$target$history$edges[[99]]$node
      [[5]]$contributors$target$history$edges[[99]]$node$committer
      [[5]]$contributors$target$history$edges[[99]]$node$committer$user
      [[5]]$contributors$target$history$edges[[99]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[99]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[5]]$contributors$target$history$edges[[100]]
      [[5]]$contributors$target$history$edges[[100]]$node
      [[5]]$contributors$target$history$edges[[100]]$node$committer
      [[5]]$contributors$target$history$edges[[100]]$node$committer$user
      [[5]]$contributors$target$history$edges[[100]]$node$committer$user$login
      [1] "maciekbanas"
      
      [[5]]$contributors$target$history$edges[[100]]$node$committer$user$id
      [1] "MDQ6VXNlcjc0MjEyOTMz"
      ...
      [[6]]$languages$nodes
      [[6]]$languages$nodes[[1]]
      [[6]]$languages$nodes[[1]]$name
      [1] "R"
      
      
      [[6]]$languages$nodes[[2]]
      [[6]]$languages$nodes[[2]]$name
      [1] "CSS"
      ...
      [[6]]$issues_open
      [[6]]$issues_open$totalCount
      [1] 0
      
      
      [[6]]$issues_closed
      [[6]]$issues_closed$totalCount
      [1] 0
      
      
      [[6]]$contributors
      [[6]]$contributors$target
      [[6]]$contributors$target$id
      [1] "C_kwDOJAtHJNoAKGU3MDJlMWYyNDQ4ZGI3YjI1YmFjOTdjNzg5MDQwMGM1MjUxY2VjZTU"
      
      [[6]]$contributors$target$history
      [[6]]$contributors$target$history$edges
      [[6]]$contributors$target$history$edges[[1]]
      [[6]]$contributors$target$history$edges[[1]]$node
      [[6]]$contributors$target$history$edges[[1]]$node$committer
      [[6]]$contributors$target$history$edges[[1]]$node$committer$user
      [[6]]$contributors$target$history$edges[[1]]$node$committer$user$login
      [1] "krystian8207"
      
      [[6]]$contributors$target$history$edges[[1]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[6]]$contributors$target$history$edges[[2]]
      [[6]]$contributors$target$history$edges[[2]]$node
      [[6]]$contributors$target$history$edges[[2]]$node$committer
      [[6]]$contributors$target$history$edges[[2]]$node$committer$user
      [[6]]$contributors$target$history$edges[[2]]$node$committer$user$login
      [1] "krystian8207"
      
      [[6]]$contributors$target$history$edges[[2]]$node$committer$user$id
      [1] "MDQ6VXNlcjIwNDU3MDQz"
      ...
      [[7]]$languages$nodes
      [[7]]$languages$nodes[[1]]
      [[7]]$languages$nodes[[1]]$name
      [1] "Shell"
      
      
      [[7]]$languages$nodes[[2]]
      [[7]]$languages$nodes[[2]]$name
      [1] "Perl"
      
      
      [[7]]$languages$nodes[[3]]
      [[7]]$languages$nodes[[3]]$name
      [1] "R"
      ...
      [[7]]$issues_open
      [[7]]$issues_open$totalCount
      [1] 0
      
      
      [[7]]$issues_closed
      [[7]]$issues_closed$totalCount
      [1] 0
      
      
      [[7]]$contributors
      [[7]]$contributors$target
      [[7]]$contributors$target$id
      [1] "C_kwDOJKQ8LtoAKDQ1NWM4MTYzM2RlNmQ2OGRjZDY3NWRkYjMxZjQ3MWM2NmU4ZmEzMzI"
      
      [[7]]$contributors$target$history
      [[7]]$contributors$target$history$edges
      [[7]]$contributors$target$history$edges[[1]]
      [[7]]$contributors$target$history$edges[[1]]$node
      [[7]]$contributors$target$history$edges[[1]]$node$committer
      [[7]]$contributors$target$history$edges[[1]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[2]]
      [[7]]$contributors$target$history$edges[[2]]$node
      [[7]]$contributors$target$history$edges[[2]]$node$committer
      [[7]]$contributors$target$history$edges[[2]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[3]]
      [[7]]$contributors$target$history$edges[[3]]$node
      [[7]]$contributors$target$history$edges[[3]]$node$committer
      [[7]]$contributors$target$history$edges[[3]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[4]]
      [[7]]$contributors$target$history$edges[[4]]$node
      [[7]]$contributors$target$history$edges[[4]]$node$committer
      [[7]]$contributors$target$history$edges[[4]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[5]]
      [[7]]$contributors$target$history$edges[[5]]$node
      [[7]]$contributors$target$history$edges[[5]]$node$committer
      [[7]]$contributors$target$history$edges[[5]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[6]]
      [[7]]$contributors$target$history$edges[[6]]$node
      [[7]]$contributors$target$history$edges[[6]]$node$committer
      [[7]]$contributors$target$history$edges[[6]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[7]]
      [[7]]$contributors$target$history$edges[[7]]$node
      [[7]]$contributors$target$history$edges[[7]]$node$committer
      [[7]]$contributors$target$history$edges[[7]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[8]]
      [[7]]$contributors$target$history$edges[[8]]$node
      [[7]]$contributors$target$history$edges[[8]]$node$committer
      [[7]]$contributors$target$history$edges[[8]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[9]]
      [[7]]$contributors$target$history$edges[[9]]$node
      [[7]]$contributors$target$history$edges[[9]]$node$committer
      [[7]]$contributors$target$history$edges[[9]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[10]]
      [[7]]$contributors$target$history$edges[[10]]$node
      [[7]]$contributors$target$history$edges[[10]]$node$committer
      [[7]]$contributors$target$history$edges[[10]]$node$committer$user
      [[7]]$contributors$target$history$edges[[10]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[10]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[11]]
      [[7]]$contributors$target$history$edges[[11]]$node
      [[7]]$contributors$target$history$edges[[11]]$node$committer
      [[7]]$contributors$target$history$edges[[11]]$node$committer$user
      [[7]]$contributors$target$history$edges[[11]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[11]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[12]]
      [[7]]$contributors$target$history$edges[[12]]$node
      [[7]]$contributors$target$history$edges[[12]]$node$committer
      [[7]]$contributors$target$history$edges[[12]]$node$committer$user
      [[7]]$contributors$target$history$edges[[12]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[12]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[13]]
      [[7]]$contributors$target$history$edges[[13]]$node
      [[7]]$contributors$target$history$edges[[13]]$node$committer
      [[7]]$contributors$target$history$edges[[13]]$node$committer$user
      [[7]]$contributors$target$history$edges[[13]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[13]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[14]]
      [[7]]$contributors$target$history$edges[[14]]$node
      [[7]]$contributors$target$history$edges[[14]]$node$committer
      [[7]]$contributors$target$history$edges[[14]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[15]]
      [[7]]$contributors$target$history$edges[[15]]$node
      [[7]]$contributors$target$history$edges[[15]]$node$committer
      [[7]]$contributors$target$history$edges[[15]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[16]]
      [[7]]$contributors$target$history$edges[[16]]$node
      [[7]]$contributors$target$history$edges[[16]]$node$committer
      [[7]]$contributors$target$history$edges[[16]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[17]]
      [[7]]$contributors$target$history$edges[[17]]$node
      [[7]]$contributors$target$history$edges[[17]]$node$committer
      [[7]]$contributors$target$history$edges[[17]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[18]]
      [[7]]$contributors$target$history$edges[[18]]$node
      [[7]]$contributors$target$history$edges[[18]]$node$committer
      [[7]]$contributors$target$history$edges[[18]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[19]]
      [[7]]$contributors$target$history$edges[[19]]$node
      [[7]]$contributors$target$history$edges[[19]]$node$committer
      [[7]]$contributors$target$history$edges[[19]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[20]]
      [[7]]$contributors$target$history$edges[[20]]$node
      [[7]]$contributors$target$history$edges[[20]]$node$committer
      [[7]]$contributors$target$history$edges[[20]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[21]]
      [[7]]$contributors$target$history$edges[[21]]$node
      [[7]]$contributors$target$history$edges[[21]]$node$committer
      [[7]]$contributors$target$history$edges[[21]]$node$committer$user
      [[7]]$contributors$target$history$edges[[21]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[21]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[22]]
      [[7]]$contributors$target$history$edges[[22]]$node
      [[7]]$contributors$target$history$edges[[22]]$node$committer
      [[7]]$contributors$target$history$edges[[22]]$node$committer$user
      [[7]]$contributors$target$history$edges[[22]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[22]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[23]]
      [[7]]$contributors$target$history$edges[[23]]$node
      [[7]]$contributors$target$history$edges[[23]]$node$committer
      [[7]]$contributors$target$history$edges[[23]]$node$committer$user
      [[7]]$contributors$target$history$edges[[23]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[23]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[24]]
      [[7]]$contributors$target$history$edges[[24]]$node
      [[7]]$contributors$target$history$edges[[24]]$node$committer
      [[7]]$contributors$target$history$edges[[24]]$node$committer$user
      [[7]]$contributors$target$history$edges[[24]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[24]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[25]]
      [[7]]$contributors$target$history$edges[[25]]$node
      [[7]]$contributors$target$history$edges[[25]]$node$committer
      [[7]]$contributors$target$history$edges[[25]]$node$committer$user
      [[7]]$contributors$target$history$edges[[25]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[25]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[26]]
      [[7]]$contributors$target$history$edges[[26]]$node
      [[7]]$contributors$target$history$edges[[26]]$node$committer
      [[7]]$contributors$target$history$edges[[26]]$node$committer$user
      [[7]]$contributors$target$history$edges[[26]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[26]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[27]]
      [[7]]$contributors$target$history$edges[[27]]$node
      [[7]]$contributors$target$history$edges[[27]]$node$committer
      [[7]]$contributors$target$history$edges[[27]]$node$committer$user
      [[7]]$contributors$target$history$edges[[27]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[27]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[28]]
      [[7]]$contributors$target$history$edges[[28]]$node
      [[7]]$contributors$target$history$edges[[28]]$node$committer
      [[7]]$contributors$target$history$edges[[28]]$node$committer$user
      [[7]]$contributors$target$history$edges[[28]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[28]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[29]]
      [[7]]$contributors$target$history$edges[[29]]$node
      [[7]]$contributors$target$history$edges[[29]]$node$committer
      [[7]]$contributors$target$history$edges[[29]]$node$committer$user
      [[7]]$contributors$target$history$edges[[29]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[29]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[30]]
      [[7]]$contributors$target$history$edges[[30]]$node
      [[7]]$contributors$target$history$edges[[30]]$node$committer
      [[7]]$contributors$target$history$edges[[30]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[31]]
      [[7]]$contributors$target$history$edges[[31]]$node
      [[7]]$contributors$target$history$edges[[31]]$node$committer
      [[7]]$contributors$target$history$edges[[31]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[32]]
      [[7]]$contributors$target$history$edges[[32]]$node
      [[7]]$contributors$target$history$edges[[32]]$node$committer
      [[7]]$contributors$target$history$edges[[32]]$node$committer$user
      [[7]]$contributors$target$history$edges[[32]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[32]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[33]]
      [[7]]$contributors$target$history$edges[[33]]$node
      [[7]]$contributors$target$history$edges[[33]]$node$committer
      [[7]]$contributors$target$history$edges[[33]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[34]]
      [[7]]$contributors$target$history$edges[[34]]$node
      [[7]]$contributors$target$history$edges[[34]]$node$committer
      [[7]]$contributors$target$history$edges[[34]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[35]]
      [[7]]$contributors$target$history$edges[[35]]$node
      [[7]]$contributors$target$history$edges[[35]]$node$committer
      [[7]]$contributors$target$history$edges[[35]]$node$committer$user
      [[7]]$contributors$target$history$edges[[35]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[35]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[36]]
      [[7]]$contributors$target$history$edges[[36]]$node
      [[7]]$contributors$target$history$edges[[36]]$node$committer
      [[7]]$contributors$target$history$edges[[36]]$node$committer$user
      [[7]]$contributors$target$history$edges[[36]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[36]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[37]]
      [[7]]$contributors$target$history$edges[[37]]$node
      [[7]]$contributors$target$history$edges[[37]]$node$committer
      [[7]]$contributors$target$history$edges[[37]]$node$committer$user
      [[7]]$contributors$target$history$edges[[37]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[37]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[38]]
      [[7]]$contributors$target$history$edges[[38]]$node
      [[7]]$contributors$target$history$edges[[38]]$node$committer
      [[7]]$contributors$target$history$edges[[38]]$node$committer$user
      [[7]]$contributors$target$history$edges[[38]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[38]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[39]]
      [[7]]$contributors$target$history$edges[[39]]$node
      [[7]]$contributors$target$history$edges[[39]]$node$committer
      [[7]]$contributors$target$history$edges[[39]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[40]]
      [[7]]$contributors$target$history$edges[[40]]$node
      [[7]]$contributors$target$history$edges[[40]]$node$committer
      [[7]]$contributors$target$history$edges[[40]]$node$committer$user
      [[7]]$contributors$target$history$edges[[40]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[40]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[41]]
      [[7]]$contributors$target$history$edges[[41]]$node
      [[7]]$contributors$target$history$edges[[41]]$node$committer
      [[7]]$contributors$target$history$edges[[41]]$node$committer$user
      [[7]]$contributors$target$history$edges[[41]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[41]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[42]]
      [[7]]$contributors$target$history$edges[[42]]$node
      [[7]]$contributors$target$history$edges[[42]]$node$committer
      [[7]]$contributors$target$history$edges[[42]]$node$committer$user
      [[7]]$contributors$target$history$edges[[42]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[42]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[43]]
      [[7]]$contributors$target$history$edges[[43]]$node
      [[7]]$contributors$target$history$edges[[43]]$node$committer
      [[7]]$contributors$target$history$edges[[43]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[44]]
      [[7]]$contributors$target$history$edges[[44]]$node
      [[7]]$contributors$target$history$edges[[44]]$node$committer
      [[7]]$contributors$target$history$edges[[44]]$node$committer$user
      [[7]]$contributors$target$history$edges[[44]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[44]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[45]]
      [[7]]$contributors$target$history$edges[[45]]$node
      [[7]]$contributors$target$history$edges[[45]]$node$committer
      [[7]]$contributors$target$history$edges[[45]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[46]]
      [[7]]$contributors$target$history$edges[[46]]$node
      [[7]]$contributors$target$history$edges[[46]]$node$committer
      [[7]]$contributors$target$history$edges[[46]]$node$committer$user
      [[7]]$contributors$target$history$edges[[46]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[46]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[47]]
      [[7]]$contributors$target$history$edges[[47]]$node
      [[7]]$contributors$target$history$edges[[47]]$node$committer
      [[7]]$contributors$target$history$edges[[47]]$node$committer$user
      [[7]]$contributors$target$history$edges[[47]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[47]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[48]]
      [[7]]$contributors$target$history$edges[[48]]$node
      [[7]]$contributors$target$history$edges[[48]]$node$committer
      [[7]]$contributors$target$history$edges[[48]]$node$committer$user
      [[7]]$contributors$target$history$edges[[48]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[48]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[49]]
      [[7]]$contributors$target$history$edges[[49]]$node
      [[7]]$contributors$target$history$edges[[49]]$node$committer
      [[7]]$contributors$target$history$edges[[49]]$node$committer$user
      [[7]]$contributors$target$history$edges[[49]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[49]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[50]]
      [[7]]$contributors$target$history$edges[[50]]$node
      [[7]]$contributors$target$history$edges[[50]]$node$committer
      [[7]]$contributors$target$history$edges[[50]]$node$committer$user
      [[7]]$contributors$target$history$edges[[50]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[50]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[51]]
      [[7]]$contributors$target$history$edges[[51]]$node
      [[7]]$contributors$target$history$edges[[51]]$node$committer
      [[7]]$contributors$target$history$edges[[51]]$node$committer$user
      [[7]]$contributors$target$history$edges[[51]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[51]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[52]]
      [[7]]$contributors$target$history$edges[[52]]$node
      [[7]]$contributors$target$history$edges[[52]]$node$committer
      [[7]]$contributors$target$history$edges[[52]]$node$committer$user
      [[7]]$contributors$target$history$edges[[52]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[52]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[53]]
      [[7]]$contributors$target$history$edges[[53]]$node
      [[7]]$contributors$target$history$edges[[53]]$node$committer
      [[7]]$contributors$target$history$edges[[53]]$node$committer$user
      [[7]]$contributors$target$history$edges[[53]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[53]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[54]]
      [[7]]$contributors$target$history$edges[[54]]$node
      [[7]]$contributors$target$history$edges[[54]]$node$committer
      [[7]]$contributors$target$history$edges[[54]]$node$committer$user
      [[7]]$contributors$target$history$edges[[54]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[54]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[55]]
      [[7]]$contributors$target$history$edges[[55]]$node
      [[7]]$contributors$target$history$edges[[55]]$node$committer
      [[7]]$contributors$target$history$edges[[55]]$node$committer$user
      [[7]]$contributors$target$history$edges[[55]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[55]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[56]]
      [[7]]$contributors$target$history$edges[[56]]$node
      [[7]]$contributors$target$history$edges[[56]]$node$committer
      [[7]]$contributors$target$history$edges[[56]]$node$committer$user
      [[7]]$contributors$target$history$edges[[56]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[56]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[57]]
      [[7]]$contributors$target$history$edges[[57]]$node
      [[7]]$contributors$target$history$edges[[57]]$node$committer
      [[7]]$contributors$target$history$edges[[57]]$node$committer$user
      [[7]]$contributors$target$history$edges[[57]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[57]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[58]]
      [[7]]$contributors$target$history$edges[[58]]$node
      [[7]]$contributors$target$history$edges[[58]]$node$committer
      [[7]]$contributors$target$history$edges[[58]]$node$committer$user
      [[7]]$contributors$target$history$edges[[58]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[58]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[59]]
      [[7]]$contributors$target$history$edges[[59]]$node
      [[7]]$contributors$target$history$edges[[59]]$node$committer
      [[7]]$contributors$target$history$edges[[59]]$node$committer$user
      [[7]]$contributors$target$history$edges[[59]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[59]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[60]]
      [[7]]$contributors$target$history$edges[[60]]$node
      [[7]]$contributors$target$history$edges[[60]]$node$committer
      [[7]]$contributors$target$history$edges[[60]]$node$committer$user
      [[7]]$contributors$target$history$edges[[60]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[60]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[61]]
      [[7]]$contributors$target$history$edges[[61]]$node
      [[7]]$contributors$target$history$edges[[61]]$node$committer
      [[7]]$contributors$target$history$edges[[61]]$node$committer$user
      [[7]]$contributors$target$history$edges[[61]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[61]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[62]]
      [[7]]$contributors$target$history$edges[[62]]$node
      [[7]]$contributors$target$history$edges[[62]]$node$committer
      [[7]]$contributors$target$history$edges[[62]]$node$committer$user
      [[7]]$contributors$target$history$edges[[62]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[62]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[63]]
      [[7]]$contributors$target$history$edges[[63]]$node
      [[7]]$contributors$target$history$edges[[63]]$node$committer
      [[7]]$contributors$target$history$edges[[63]]$node$committer$user
      [[7]]$contributors$target$history$edges[[63]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[63]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[64]]
      [[7]]$contributors$target$history$edges[[64]]$node
      [[7]]$contributors$target$history$edges[[64]]$node$committer
      [[7]]$contributors$target$history$edges[[64]]$node$committer$user
      [[7]]$contributors$target$history$edges[[64]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[64]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[65]]
      [[7]]$contributors$target$history$edges[[65]]$node
      [[7]]$contributors$target$history$edges[[65]]$node$committer
      [[7]]$contributors$target$history$edges[[65]]$node$committer$user
      [[7]]$contributors$target$history$edges[[65]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[65]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[66]]
      [[7]]$contributors$target$history$edges[[66]]$node
      [[7]]$contributors$target$history$edges[[66]]$node$committer
      [[7]]$contributors$target$history$edges[[66]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[67]]
      [[7]]$contributors$target$history$edges[[67]]$node
      [[7]]$contributors$target$history$edges[[67]]$node$committer
      [[7]]$contributors$target$history$edges[[67]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[68]]
      [[7]]$contributors$target$history$edges[[68]]$node
      [[7]]$contributors$target$history$edges[[68]]$node$committer
      [[7]]$contributors$target$history$edges[[68]]$node$committer$user
      [[7]]$contributors$target$history$edges[[68]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[68]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[69]]
      [[7]]$contributors$target$history$edges[[69]]$node
      [[7]]$contributors$target$history$edges[[69]]$node$committer
      [[7]]$contributors$target$history$edges[[69]]$node$committer$user
      [[7]]$contributors$target$history$edges[[69]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[69]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[70]]
      [[7]]$contributors$target$history$edges[[70]]$node
      [[7]]$contributors$target$history$edges[[70]]$node$committer
      [[7]]$contributors$target$history$edges[[70]]$node$committer$user
      [[7]]$contributors$target$history$edges[[70]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[70]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[71]]
      [[7]]$contributors$target$history$edges[[71]]$node
      [[7]]$contributors$target$history$edges[[71]]$node$committer
      [[7]]$contributors$target$history$edges[[71]]$node$committer$user
      [[7]]$contributors$target$history$edges[[71]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[71]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[72]]
      [[7]]$contributors$target$history$edges[[72]]$node
      [[7]]$contributors$target$history$edges[[72]]$node$committer
      [[7]]$contributors$target$history$edges[[72]]$node$committer$user
      [[7]]$contributors$target$history$edges[[72]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[72]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[73]]
      [[7]]$contributors$target$history$edges[[73]]$node
      [[7]]$contributors$target$history$edges[[73]]$node$committer
      [[7]]$contributors$target$history$edges[[73]]$node$committer$user
      [[7]]$contributors$target$history$edges[[73]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[73]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[74]]
      [[7]]$contributors$target$history$edges[[74]]$node
      [[7]]$contributors$target$history$edges[[74]]$node$committer
      [[7]]$contributors$target$history$edges[[74]]$node$committer$user
      [[7]]$contributors$target$history$edges[[74]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[74]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[75]]
      [[7]]$contributors$target$history$edges[[75]]$node
      [[7]]$contributors$target$history$edges[[75]]$node$committer
      [[7]]$contributors$target$history$edges[[75]]$node$committer$user
      [[7]]$contributors$target$history$edges[[75]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[75]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[76]]
      [[7]]$contributors$target$history$edges[[76]]$node
      [[7]]$contributors$target$history$edges[[76]]$node$committer
      [[7]]$contributors$target$history$edges[[76]]$node$committer$user
      [[7]]$contributors$target$history$edges[[76]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[76]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[77]]
      [[7]]$contributors$target$history$edges[[77]]$node
      [[7]]$contributors$target$history$edges[[77]]$node$committer
      [[7]]$contributors$target$history$edges[[77]]$node$committer$user
      [[7]]$contributors$target$history$edges[[77]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[77]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[78]]
      [[7]]$contributors$target$history$edges[[78]]$node
      [[7]]$contributors$target$history$edges[[78]]$node$committer
      [[7]]$contributors$target$history$edges[[78]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[79]]
      [[7]]$contributors$target$history$edges[[79]]$node
      [[7]]$contributors$target$history$edges[[79]]$node$committer
      [[7]]$contributors$target$history$edges[[79]]$node$committer$user
      [[7]]$contributors$target$history$edges[[79]]$node$committer$user$login
      [1] "ablack3"
      
      [[7]]$contributors$target$history$edges[[79]]$node$committer$user$id
      [1] "MDQ6VXNlcjEwMjI3NTIy"
      ...
      [[7]]$contributors$target$history$edges[[80]]
      [[7]]$contributors$target$history$edges[[80]]$node
      [[7]]$contributors$target$history$edges[[80]]$node$committer
      [[7]]$contributors$target$history$edges[[80]]$node$committer$user
      [[7]]$contributors$target$history$edges[[80]]$node$committer$user$login
      [1] "ablack3"
      
      [[7]]$contributors$target$history$edges[[80]]$node$committer$user$id
      [1] "MDQ6VXNlcjEwMjI3NTIy"
      ...
      [[7]]$contributors$target$history$edges[[81]]
      [[7]]$contributors$target$history$edges[[81]]$node
      [[7]]$contributors$target$history$edges[[81]]$node$committer
      [[7]]$contributors$target$history$edges[[81]]$node$committer$user
      [[7]]$contributors$target$history$edges[[81]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[81]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[82]]
      [[7]]$contributors$target$history$edges[[82]]$node
      [[7]]$contributors$target$history$edges[[82]]$node$committer
      [[7]]$contributors$target$history$edges[[82]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[83]]
      [[7]]$contributors$target$history$edges[[83]]$node
      [[7]]$contributors$target$history$edges[[83]]$node$committer
      [[7]]$contributors$target$history$edges[[83]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[84]]
      [[7]]$contributors$target$history$edges[[84]]$node
      [[7]]$contributors$target$history$edges[[84]]$node$committer
      [[7]]$contributors$target$history$edges[[84]]$node$committer$user
      [[7]]$contributors$target$history$edges[[84]]$node$committer$user$login
      [1] "azimov"
      
      [[7]]$contributors$target$history$edges[[84]]$node$committer$user$id
      [1] "MDQ6VXNlcjE4MDY1OQ=="
      ...
      [[7]]$contributors$target$history$edges[[85]]
      [[7]]$contributors$target$history$edges[[85]]$node
      [[7]]$contributors$target$history$edges[[85]]$node$committer
      [[7]]$contributors$target$history$edges[[85]]$node$committer$user
      [[7]]$contributors$target$history$edges[[85]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[85]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[86]]
      [[7]]$contributors$target$history$edges[[86]]$node
      [[7]]$contributors$target$history$edges[[86]]$node$committer
      [[7]]$contributors$target$history$edges[[86]]$node$committer$user
      [[7]]$contributors$target$history$edges[[86]]$node$committer$user$login
      [1] "ablack3"
      
      [[7]]$contributors$target$history$edges[[86]]$node$committer$user$id
      [1] "MDQ6VXNlcjEwMjI3NTIy"
      ...
      [[7]]$contributors$target$history$edges[[87]]
      [[7]]$contributors$target$history$edges[[87]]$node
      [[7]]$contributors$target$history$edges[[87]]$node$committer
      [[7]]$contributors$target$history$edges[[87]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[88]]
      [[7]]$contributors$target$history$edges[[88]]$node
      [[7]]$contributors$target$history$edges[[88]]$node$committer
      [[7]]$contributors$target$history$edges[[88]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[89]]
      [[7]]$contributors$target$history$edges[[89]]$node
      [[7]]$contributors$target$history$edges[[89]]$node$committer
      [[7]]$contributors$target$history$edges[[89]]$node$committer$user
      [[7]]$contributors$target$history$edges[[89]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[89]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[90]]
      [[7]]$contributors$target$history$edges[[90]]$node
      [[7]]$contributors$target$history$edges[[90]]$node$committer
      [[7]]$contributors$target$history$edges[[90]]$node$committer$user
      [[7]]$contributors$target$history$edges[[90]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[90]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[91]]
      [[7]]$contributors$target$history$edges[[91]]$node
      [[7]]$contributors$target$history$edges[[91]]$node$committer
      [[7]]$contributors$target$history$edges[[91]]$node$committer$user
      [[7]]$contributors$target$history$edges[[91]]$node$committer$user$login
      [1] "ablack3"
      
      [[7]]$contributors$target$history$edges[[91]]$node$committer$user$id
      [1] "MDQ6VXNlcjEwMjI3NTIy"
      ...
      [[7]]$contributors$target$history$edges[[92]]
      [[7]]$contributors$target$history$edges[[92]]$node
      [[7]]$contributors$target$history$edges[[92]]$node$committer
      [[7]]$contributors$target$history$edges[[92]]$node$committer$user
      [[7]]$contributors$target$history$edges[[92]]$node$committer$user$login
      [1] "ablack3"
      
      [[7]]$contributors$target$history$edges[[92]]$node$committer$user$id
      [1] "MDQ6VXNlcjEwMjI3NTIy"
      ...
      [[7]]$contributors$target$history$edges[[93]]
      [[7]]$contributors$target$history$edges[[93]]$node
      [[7]]$contributors$target$history$edges[[93]]$node$committer
      [[7]]$contributors$target$history$edges[[93]]$node$committer$user
      [[7]]$contributors$target$history$edges[[93]]$node$committer$user$login
      [1] "ablack3"
      
      [[7]]$contributors$target$history$edges[[93]]$node$committer$user$id
      [1] "MDQ6VXNlcjEwMjI3NTIy"
      ...
      [[7]]$contributors$target$history$edges[[94]]
      [[7]]$contributors$target$history$edges[[94]]$node
      [[7]]$contributors$target$history$edges[[94]]$node$committer
      [[7]]$contributors$target$history$edges[[94]]$node$committer$user
      [[7]]$contributors$target$history$edges[[94]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[94]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[95]]
      [[7]]$contributors$target$history$edges[[95]]$node
      [[7]]$contributors$target$history$edges[[95]]$node$committer
      [[7]]$contributors$target$history$edges[[95]]$node$committer$user
      [[7]]$contributors$target$history$edges[[95]]$node$committer$user$login
      [1] "ablack3"
      
      [[7]]$contributors$target$history$edges[[95]]$node$committer$user$id
      [1] "MDQ6VXNlcjEwMjI3NTIy"
      ...
      [[7]]$contributors$target$history$edges[[96]]
      [[7]]$contributors$target$history$edges[[96]]$node
      [[7]]$contributors$target$history$edges[[96]]$node$committer
      [[7]]$contributors$target$history$edges[[96]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[97]]
      [[7]]$contributors$target$history$edges[[97]]$node
      [[7]]$contributors$target$history$edges[[97]]$node$committer
      [[7]]$contributors$target$history$edges[[97]]$node$committer$user
      [[7]]$contributors$target$history$edges[[97]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[97]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[98]]
      [[7]]$contributors$target$history$edges[[98]]$node
      [[7]]$contributors$target$history$edges[[98]]$node$committer
      [[7]]$contributors$target$history$edges[[98]]$node$committer$user
      NULL
      
      
      
      
      [[7]]$contributors$target$history$edges[[99]]
      [[7]]$contributors$target$history$edges[[99]]$node
      [[7]]$contributors$target$history$edges[[99]]$node$committer
      [[7]]$contributors$target$history$edges[[99]]$node$committer$user
      [[7]]$contributors$target$history$edges[[99]]$node$committer$user$login
      [1] "gowthamrao"
      
      [[7]]$contributors$target$history$edges[[99]]$node$committer$user$id
      [1] "MDQ6VXNlcjEzOTM2NjAw"
      ...
      [[7]]$contributors$target$history$edges[[100]]
      [[7]]$contributors$target$history$edges[[100]]$node
      [[7]]$contributors$target$history$edges[[100]]$node$committer
      [[7]]$contributors$target$history$edges[[100]]$node$committer$user
      NULL
      ...
      [[8]]$issues_open
      [[8]]$issues_open$totalCount
      [1] 0
      
      
      [[8]]$issues_closed
      [[8]]$issues_closed$totalCount
      [1] 0
