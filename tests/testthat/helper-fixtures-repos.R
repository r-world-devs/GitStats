...
# Minimal repos_by_org response (only fullPath, used by per-repo fallback)
test_fixtures$gitlab_repos_by_org_minimal_response <- list(
  "data" = list(
    "group" = list(
      "projects" = list(
        "count" = 2,
        ...
        "edges" = list(
          list("node" = list("fullPath" = "mbtests/gitstatstesting")),
          list("node" = list("fullPath" = "mbtests/gitstats-testing-2"))
        )
      )
    )
  )
...
# Light per-repo response (no languages, no issueStatusCounts)
gitlab_project_node_light <- list(
  "repo_id" = "gid://gitlab/Project/61399846",
  "repo_name" = "gitstatstesting",
  "repo_path" = "gitstatstesting",
  "repo_fullpath" = "mbtests/gitstatstesting",
...
test_fixtures$gitlab_repo_by_fullpath_light_response <- list(
  "data" = list(
    "project" = gitlab_project_node_light
  )
)
