...
The goal of GitStats is to search through multiple GitHub and GitLab platforms for statistics.
...
Start with setting your git connections: choose GitHub Client or GitLab Client class.
Choose your owners (GitHub) or group/groups (GitLab). 
...
Wrap all your Clients into new GitStats object (you can have them more than two):
